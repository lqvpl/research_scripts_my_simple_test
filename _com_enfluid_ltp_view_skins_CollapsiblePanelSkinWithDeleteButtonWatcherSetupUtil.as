package
{
   ...
   public class _com_enfluid_ltp_view_skins_CollapsiblePanelSkinWithDeleteButtonWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _com_enfluid_ltp_view_skins_CollapsiblePanelSkinWithDeleteButtonWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         CollapsiblePanelSkinWithDeleteButton.watcherSetupUtil = new _com_enfluid_ltp_view_skins_CollapsiblePanelSkinWithDeleteButtonWatcherSetupUtil();
      }
