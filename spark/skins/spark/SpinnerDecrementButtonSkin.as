package spark.skins.spark
{
   ...
   public class SpinnerDecrementButtonSkin extends SparkSkin implements IStateClient2
   {
      ...
      private var _1077090345_SpinnerDecrementButtonSkin_Group1:Group;
      
      public var _SpinnerDecrementButtonSkin_Rect3:Rect;
      ...
      public function SpinnerDecrementButtonSkin()
      {
         ...
         this.mxmlContent = [this._SpinnerDecrementButtonSkin_Group1_i(),this._SpinnerDecrementButtonSkin_Path1_i()];
         this.currentState = "up";
         var _loc1_:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._SpinnerDecrementButtonSkin_Rect3_i);
         states = [new State({
            "name":"up",
            "overrides":[]
         }),new State({
            ...
            "overrides":[new AddItems().initializeFromObject({
               "itemsFactory":_loc1_,
               "destination":"_SpinnerDecrementButtonSkin_Group1",
      ...
      private function _SpinnerDecrementButtonSkin_Group1_i() : Group
      {
         ...
         _loc1_.right = 0;
         _loc1_.bottom = 0;
         _loc1_.mxmlContent = [this._SpinnerDecrementButtonSkin_Rect1_i(),this._SpinnerDecrementButtonSkin_Rect2_i()];
         _loc1_.id = "_SpinnerDecrementButtonSkin_Group1";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._SpinnerDecrementButtonSkin_Group1 = _loc1_;
         BindingManager.executeBindings(this,"_SpinnerDecrementButtonSkin_Group1",this._SpinnerDecrementButtonSkin_Group1);
         return _loc1_;
      }
      ...
      private function _SpinnerDecrementButtonSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.stroke = this._SpinnerDecrementButtonSkin_SolidColorStroke1_c();
      ...
      private function _SpinnerDecrementButtonSkin_SolidColorStroke1_c() : SolidColorStroke
      {
      ...
      private function _SpinnerDecrementButtonSkin_Rect3_i() : Rect
      {
         ...
         _loc1_.right = 1;
         _loc1_.height = 1;
         _loc1_.fill = this._SpinnerDecrementButtonSkin_SolidColor1_c();
         _loc1_.initialized(this,"_SpinnerDecrementButtonSkin_Rect3");
         this._SpinnerDecrementButtonSkin_Rect3 = _loc1_;
         BindingManager.executeBindings(this,"_SpinnerDecrementButtonSkin_Rect3",this._SpinnerDecrementButtonSkin_Rect3);
         return _loc1_;
      }
      
      private function _SpinnerDecrementButtonSkin_SolidColor1_c() : SolidColor
      {
      ...
      private function _SpinnerDecrementButtonSkin_Path1_i() : Path
      {
         ...
         _loc1_.fill = this._SpinnerDecrementButtonSkin_SolidColor2_i();
      ...
      private function _SpinnerDecrementButtonSkin_SolidColor2_i() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 0;
         _loc1_.alpha = 0.8;
      ...
      [Bindable(event="propertyChange")]
      public function get _SpinnerDecrementButtonSkin_Group1() : Group
      {
         return this._1077090345_SpinnerDecrementButtonSkin_Group1;
      }
      
      public function set _SpinnerDecrementButtonSkin_Group1(param1:Group) : void
      {
         var _loc2_:Object = this._1077090345_SpinnerDecrementButtonSkin_Group1;
         if(_loc2_ !== param1)
         {
            this._1077090345_SpinnerDecrementButtonSkin_Group1 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_SpinnerDecrementButtonSkin_Group1",_loc2_,param1));
            }
         }
      }
