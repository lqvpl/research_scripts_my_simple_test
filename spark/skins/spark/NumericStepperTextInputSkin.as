package spark.skins.spark
{
   ...
   public class NumericStepperTextInputSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function NumericStepperTextInputSkin()
      {
         super();
         mx_internal::_document = this;
         this.mxmlContent = [this._NumericStepperTextInputSkin_Rect1_i(),this._NumericStepperTextInputSkin_Rect2_i(),this._NumericStepperTextInputSkin_Rect3_i(),this._NumericStepperTextInputSkin_RichEditableText1_i()];
      ...
      private function _NumericStepperTextInputSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.stroke = this._NumericStepperTextInputSkin_SolidColorStroke1_i();
      ...
      private function _NumericStepperTextInputSkin_SolidColorStroke1_i() : SolidColorStroke
      {
      ...
      private function _NumericStepperTextInputSkin_Rect2_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.right = 1;
         _loc1_.top = 1;
         _loc1_.bottom = 1;
         _loc1_.fill = this._NumericStepperTextInputSkin_SolidColor1_i();
      ...
      private function _NumericStepperTextInputSkin_SolidColor1_i() : SolidColor
      {
      ...
      private function _NumericStepperTextInputSkin_Rect3_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.top = 1;
         _loc1_.right = 1;
         _loc1_.height = 1;
         _loc1_.fill = this._NumericStepperTextInputSkin_SolidColor2_c();
      ...
      private function _NumericStepperTextInputSkin_SolidColor2_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 0;
         _loc1_.alpha = 0.12;
      ...
      private function _NumericStepperTextInputSkin_RichEditableText1_i() : RichEditableText
      {
