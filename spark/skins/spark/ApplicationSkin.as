package spark.skins.spark
{
   ...
   public class ApplicationSkin extends Skin implements IStateClient2
   {
      ...
      private var _2141647012containerGrp:Group;
      ...
      override public function styleChanged(param1:String) : void
      {
         ...
         if(_loc2_ || param1 == "osStatusBarHeight")
         {
            _loc3_ = Number(getStyle("osStatusBarHeight"));
            this.containerGrp.top = !!isNaN(_loc3_)?0:_loc3_;
         }
      }
      ...
      private function _ApplicationSkin_Group1_i() : Group
      {
         ...
         _loc1_.id = "containerGrp";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this.containerGrp = _loc1_;
         BindingManager.executeBindings(this,"containerGrp",this.containerGrp);
         return _loc1_;
      }
      ...
      [Bindable(event="propertyChange")]
      public function get containerGrp() : Group
      {
         return this._2141647012containerGrp;
      }
      
      public function set containerGrp(param1:Group) : void
      {
         var _loc2_:Object = this._2141647012containerGrp;
         if(_loc2_ !== param1)
         {
            this._2141647012containerGrp = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"containerGrp",_loc2_,param1));
            }
         }
      }
