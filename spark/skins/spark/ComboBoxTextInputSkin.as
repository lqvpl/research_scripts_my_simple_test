package spark.skins.spark
{
   ...
   public class ComboBoxTextInputSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function ComboBoxTextInputSkin()
      {
         ...
         this.mxmlContent = [this._ComboBoxTextInputSkin_Rect1_i(),this._ComboBoxTextInputSkin_Rect2_i(),this._ComboBoxTextInputSkin_Rect3_i(),this._ComboBoxTextInputSkin_RichEditableText1_i()];
      ...
      private function _ComboBoxTextInputSkin_Rect1_i() : Rect
      {
      ...
      private function _ComboBoxTextInputSkin_Rect2_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.right = 1;
      ...
      private function _ComboBoxTextInputSkin_Rect3_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.top = 1;
         _loc1_.right = 1;
         _loc1_.height = 1;
         _loc1_.fill = this._ComboBoxTextInputSkin_SolidColor2_c();
      ...
      private function _ComboBoxTextInputSkin_SolidColor2_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 0;
         _loc1_.alpha = 0.12;
