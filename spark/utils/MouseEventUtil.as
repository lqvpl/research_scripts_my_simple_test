package spark.utils
{
   ...
   public class MouseEventUtil
   {
      ...
      {
         var _loc2_:FlexMouseEvent = new FlexMouseEvent(FlexMouseEvent.MOUSE_WHEEL_CHANGING,true,true,param1.localX,param1.localY,InteractiveObject(param1.target),param1.ctrlKey,param1.altKey,param1.shiftKey,param1.buttonDown,param1.delta);
         return _loc2_;
      }
   }
}
