package spark.filters
{
   ...
   public class DropShadowFilter extends BaseDimensionFilter implements IBitmapFilter
   {
      ...
      public function DropShadowFilter(param1:Number = 4.0, param2:Number = 45, param3:uint = 0, param4:Number = 1.0, param5:Number = 4.0, param6:Number = 4.0, param7:Number = 1.0, param8:int = 1, param9:Boolean = false, param10:Boolean = false, param11:Boolean = false)
      {
         super();
