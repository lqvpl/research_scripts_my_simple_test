package spark.layouts.supportClasses
{
   ...
   public final class LinearLayoutVector
   {
      ...
      private const blockTable:Vector.<spark.layouts.supportClasses.Block> = new Vector.<spark.layouts.supportClasses.Block>(0,false);
      ...
      private function setLength(param1:uint) : void
      {
         ...
         this._length = param1;
         var _loc2_:uint = (this._length & BLOCK_MASK) == 0?uint(0):uint(1);
      ...
      public function getMajorSize(param1:uint) : Number
      {
         ...
         this.flushPendingChanges();
         var _loc2_:spark.layouts.supportClasses.Block = this.blockTable[param1 >> BLOCK_SHIFT];
         if(_loc2_)
         {
      ...
      public function setMajorSize(param1:uint, param2:Number) : void
      {
         ...
         var _loc4_:spark.layouts.supportClasses.Block = this.blockTable[_loc3_];
         if(!_loc4_)
         {
            _loc4_ = this.blockTable[_loc3_] = new spark.layouts.supportClasses.Block();
         }
         ...
         if(isNaN(_loc7_))
         {
            _loc4_.defaultCount = _loc4_.defaultCount - 1;
            _loc4_.sizesSum = _loc4_.sizesSum + param2;
         }
         else if(isNaN(param2))
         {
            _loc4_.defaultCount = _loc4_.defaultCount + 1;
            _loc4_.sizesSum = _loc4_.sizesSum - _loc7_;
         }
         else
         {
            _loc4_.sizesSum = _loc4_.sizesSum + (param2 - _loc7_);
         }
      ...
      private function isIntervalClear(param1:spark.layouts.supportClasses.Block, param2:int, param3:int) : Boolean
      {
      ...
      private function inBlockCopy(param1:spark.layouts.supportClasses.Block, param2:int, param3:spark.layouts.supportClasses.Block, param4:int, param5:int) : void
      {
         var _loc6_:* = param2 < param4;
         var _loc7_:int = !!_loc6_?int(param4):int(param4 + param5 - 1);
         ...
         param1.sizesSum = param1.sizesSum + _loc14_;
         param1.defaultCount = param1.defaultCount + _loc15_;
      }
      ...
      private function copyInterval(param1:int, param2:int, param3:int) : void
      {
         var _loc5_:uint = 0;
         var _loc6_:uint = 0;
         var _loc7_:spark.layouts.supportClasses.Block = null;
         var _loc8_:uint = 0;
         var _loc9_:uint = 0;
         var _loc10_:spark.layouts.supportClasses.Block = null;
         var _loc11_:int = 0;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         ...
         while(param3 > 0)
         {
            ...
            {
               _loc7_ = new spark.layouts.supportClasses.Block();
            ...
            param1 = param1 + (!!_loc4_?_loc11_:-_loc11_);
            param2 = param2 + (!!_loc4_?_loc11_:-_loc11_);
            param3 = param3 - _loc11_;
         }
      }
      ...
      private function clearInterval(param1:int, param2:int) : void
      {
         var _loc3_:uint = 0;
         var _loc4_:uint = 0;
         var _loc5_:spark.layouts.supportClasses.Block = null;
         var _loc6_:int = 0;
         while(param1 <= param2)
         {
            _loc3_ = param1 >> BLOCK_SHIFT;
      ...
      {
         var _loc8_:spark.layouts.supportClasses.Block = null;
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            if(_loc8_)
            {
               _loc2_ = _loc2_ + (_loc8_.sizesSum + _loc8_.defaultCount * this._defaultMajorSize);
            }
            else
            {
               _loc2_ = _loc2_ + BLOCK_SIZE * this._defaultMajorSize;
            }
            _loc4_++;
         }
         var _loc5_:spark.layouts.supportClasses.Block = this.blockTable[_loc3_];
         ...
         if(_loc5_)
         {
            ...
            while(_loc4_ < _loc7_)
            {
               ...
               _loc2_ = _loc2_ + (!!isNaN(_loc10_)?this._defaultMajorSize:_loc10_);
               _loc4_++;
            }
         }
         else
         {
            _loc2_ = _loc2_ + this._defaultMajorSize * _loc7_;
         }
         _loc2_ = _loc2_ + param1 * this.gap;
         return _loc2_;
      }
      ...
      private function indexOfInternal(param1:Number) : int
      {
         ...
         var _loc3_:* = -1;
         var _loc4_:spark.layouts.supportClasses.Block = null;
         ...
         while(_loc6_ < this.blockTable.length)
         {
            ...
            if(_loc4_)
            {
               _loc7_ = _loc7_ + (_loc4_.sizesSum + _loc4_.defaultCount * this._defaultMajorSize);
            }
            else
            {
               _loc7_ = _loc7_ + BLOCK_SIZE * this._defaultMajorSize;
            }
         ...
         if(_loc4_)
         {
            ...
            while(_loc9_ < BLOCK_SIZE - 1)
            {
               ...
               _loc2_ = _loc2_ + (this._gap + (!!isNaN(_loc10_)?this._defaultMajorSize:_loc10_));
               if(_loc2_ > param1)
               {
