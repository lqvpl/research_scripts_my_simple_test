package spark.components
{
   ...
   public class Image extends SkinnableComponent
   {
      ...
      {
         return !!this.imageDisplay?Number(this.imageDisplay.bytesLoaded):Number(NaN);
      }
      
      public function get bytesTotal() : Number
      {
         return !!this.imageDisplay?Number(this.imageDisplay.bytesTotal):Number(NaN);
      }
      ...
      public function set clearOnLoad(param1:Boolean) : void
      {
         ...
         {
            this.imageDisplayProperties.clearOnLoad = param1;
         }
      }
      ...
      public function set contentLoader(param1:IContentLoader) : void
      {
         ...
         {
            this.imageDisplayProperties.contentLoader = param1;
         }
      }
      ...
      public function set contentLoaderGrouping(param1:String) : void
      {
         ...
         {
            this.imageDisplayProperties.contentLoaderGrouping = param1;
         }
      }
      ...
      public function set fillMode(param1:String) : void
      {
         ...
         {
            this.imageDisplayProperties.fillMode = param1;
         }
      }
      ...
      public function set horizontalAlign(param1:String) : void
      {
         if(this.imageDisplay)
         {
            ...
            this.imageDisplayProperties = BitFlagUtil.update(this.imageDisplayProperties as uint,HORIZONTAL_ALIGN_PROPERTY_FLAG,param1 != null);
         }
         else
         {
            this.imageDisplayProperties.horizontalAlign = param1;
         }
      }
      ...
      public function set preliminaryHeight(param1:Number) : void
      {
         ...
         {
            this.imageDisplayProperties.preliminaryHeight = param1;
         }
      }
      ...
      public function set preliminaryWidth(param1:Number) : void
      {
         ...
         {
            this.imageDisplayProperties.preliminaryWidth = param1;
         }
      }
      ...
      public function set scaleMode(param1:String) : void
      {
         ...
         {
            this.imageDisplayProperties.scaleMode = param1;
         }
      }
      ...
      public function set smooth(param1:Boolean) : void
      {
         ...
         {
            this.imageDisplayProperties.smooth = param1;
         }
      }
      ...
      public function set source(param1:Object) : void
      {
         ...
         if(this.imageDisplay)
         {
            ...
            this.imageDisplayProperties = BitFlagUtil.update(this.imageDisplayProperties as uint,SOURCE_PROPERTY_FLAG,param1 != null);
         }
         else
         {
            this.imageDisplayProperties.source = param1;
         }
         invalidateSkinState();
      ...
      public function set verticalAlign(param1:String) : void
      {
         if(this.imageDisplay)
         {
            ...
            this.imageDisplayProperties = BitFlagUtil.update(this.imageDisplayProperties as uint,VERTICAL_ALIGN_PROPERTY_FLAG,param1 != null);
         }
         else
         {
            this.imageDisplayProperties.verticalAlign = param1;
         }
      }
      ...
      override protected function partAdded(param1:String, param2:Object) : void
      {
         ...
         if(param2 == this.imageDisplay)
         {
            ...
            if(this.imageDisplayProperties.clearOnLoad !== undefined)
            {
               ...
               _loc3_ = BitFlagUtil.update(_loc3_,CLEAR_ON_LOAD_PROPERTY_FLAG,true);
            }
            if(this.imageDisplayProperties.contentLoader !== undefined)
            {
               ...
               _loc3_ = BitFlagUtil.update(_loc3_,CONTENT_LOADER_PROPERTY_FLAG,true);
            }
            if(this.imageDisplayProperties.contentLoaderGrouping !== undefined)
            {
               ...
               _loc3_ = BitFlagUtil.update(_loc3_,CONTENT_LOADER_GROUPING_PROPERTY_FLAG,true);
            }
            if(this.imageDisplayProperties.fillMode !== undefined)
            {
               this.imageDisplay.fillMode = this.imageDisplayProperties.fillMode;
               _loc3_ = BitFlagUtil.update(_loc3_,FILL_MODE_PROPERTY_FLAG,true);
            }
            if(this.imageDisplayProperties.preliminaryHeight !== undefined)
            {
               ...
               _loc3_ = BitFlagUtil.update(_loc3_,PRELIMINARY_HEIGHT_PROPERTY_FLAG,true);
            }
            ...
            if(this.imageDisplayProperties.smoothingQuality !== undefined)
            {
               ...
               _loc3_ = BitFlagUtil.update(_loc3_,SMOOTHING_QUALITY_PROPERTY_FLAG,true);
            }
            if(this.imageDisplayProperties.scaleMode !== undefined)
            {
               this.imageDisplay.scaleMode = this.imageDisplayProperties.scaleMode;
               _loc3_ = BitFlagUtil.update(_loc3_,SCALE_MODE_PROPERTY_FLAG,true);
            }
            if(this.imageDisplayProperties.verticalAlign !== undefined)
            {
               ...
               _loc3_ = BitFlagUtil.update(_loc3_,VERTICAL_ALIGN_PROPERTY_FLAG,true);
            }
            if(this.imageDisplayProperties.horizontalAlign !== undefined)
            {
               ...
               _loc3_ = BitFlagUtil.update(_loc3_,HORIZONTAL_ALIGN_PROPERTY_FLAG,true);
            }
            this.imageDisplayProperties = _loc3_;
            this.imageDisplay.validateSource();
         }
         else if(param2 == this.progressIndicator)
         {
            if(this._loading && this.progressIndicator && this.imageDisplay)
            {
      ...
      private function set smoothQuality(param1:String) : void
      {
         if(this.imageDisplay)
         {
            ...
            this.imageDisplayProperties = BitFlagUtil.update(this.imageDisplayProperties as uint,SMOOTHING_QUALITY_PROPERTY_FLAG,param1 != null);
         }
         else
         {
            this.imageDisplayProperties.smoothingQuality = param1;
         }
      }
