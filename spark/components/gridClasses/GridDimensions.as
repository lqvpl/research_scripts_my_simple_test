package spark.components.gridClasses
{
   ...
   public class GridDimensions
   {
      ...
      private var rowList:spark.components.gridClasses.GridRowList;
      
      private var _columnWidths:Vector.<Number>;
      
      private var startY:Number = 0;
      
      private var recentNode:spark.components.gridClasses.GridRowNode = null;
      
      private var startY2:Number = 0;
      
      private var recentNode2:spark.components.gridClasses.GridRowNode = null;
      ...
      {
         this.rowList = new spark.components.gridClasses.GridRowList();
      ...
      public static function insertElementsToVector(param1:Vector.<Number>, param2:int, param3:Vector.<Number>) : void
      {
         ...
         param1.length = param1.length + _loc5_;
      ...
      public static function insertValueToVector(param1:Vector.<Number>, param2:int, param3:int, param4:Number) : void
      {
         ...
         param1.length = param1.length + param3;
         var _loc6_:int = param1.length;
      ...
      {
         var _loc5_:int = param4 == -1?int(param1.length):int(param3 + param4);
      ...
      {
         return !!this.useMaxTypicalCellHeight?Number(this.maxTypicalCellHeight):Number(this._defaultRowHeight);
      }
      ...
      public function set defaultColumnWidth(param1:Number) : void
      {
         if(param1 == this._defaultColumnWidth)
         {
            return;
         }
         this._defaultColumnWidth = param1;
      }
      ...
      {
         var _loc3_:spark.components.gridClasses.GridRowNode = null;
         ...
         return !isNaN(_loc2_)?Number(bound(_loc2_,this.minRowHeight,this.maxRowHeight)):Number(_loc2_);
      }
      ...
      public function setRowHeight(param1:int, param2:Number) : void
      {
         ...
         var _loc3_:spark.components.gridClasses.GridRowNode = this.rowList.find(param1);
         if(_loc3_)
         {
      ...
      public function setCellHeight(param1:int, param2:int, param3:Number) : void
      {
         ...
         var _loc4_:spark.components.gridClasses.GridRowNode = this.rowList.find(param1);
         ...
         if(_loc4_ && _loc4_.setCellHeight(param2,param3))
         {
            if(this.recentNode && _loc4_.rowIndex < this.recentNode.rowIndex)
            {
               this.startY = this.startY + (_loc4_.maxCellHeight - _loc5_);
            }
            if(this.recentNode2 && _loc4_.rowIndex < this.recentNode2.rowIndex)
            {
               this.startY2 = this.startY2 + (_loc4_.maxCellHeight - _loc5_);
            }
         }
      }
      ...
      public function getCellX(param1:int, param2:int) : Number
      {
         ...
         while(_loc4_ < param2)
         {
            _loc3_ = _loc3_ + (this.getColumnWidth(_loc4_) + this.columnGap);
            _loc4_++;
         }
         return _loc3_;
      }
      ...
      private function getPrevYAt(param1:int, param2:spark.components.gridClasses.GridRowNode, param3:Number) : Number
      {
         var _loc6_:spark.components.gridClasses.GridRowNode = null;
         var _loc8_:int = 0;
         var _loc4_:spark.components.gridClasses.GridRowNode = param2;
         ...
         while(_loc4_)
         {
            ...
            _loc6_ = _loc4_.prev;
            if(!_loc6_ || param1 < _loc4_.rowIndex && param1 > _loc6_.rowIndex)
            {
               _loc8_ = _loc4_.rowIndex - param1;
               _loc7_ = _loc7_ - _loc8_ * (this.defaultRowHeight + this.rowGap);
               break;
            }
            _loc8_ = _loc4_.rowIndex - _loc6_.rowIndex - 1;
            _loc7_ = _loc7_ - _loc8_ * (this.defaultRowHeight + this.rowGap) - (this.getRowHeight(_loc6_.rowIndex) + this.rowGap);
            _loc5_ = _loc7_;
            _loc4_ = _loc6_;
         }
      ...
      private function getNextYAt(param1:int, param2:spark.components.gridClasses.GridRowNode, param3:Number) : Number
      {
         var _loc6_:spark.components.gridClasses.GridRowNode = null;
         var _loc8_:int = 0;
         var _loc4_:spark.components.gridClasses.GridRowNode = param2;
         ...
         while(_loc4_)
         {
            ...
            _loc7_ = _loc7_ + this.getRowHeight(_loc4_.rowIndex);
            if(_loc4_.rowIndex < this._rowCount - 1)
            {
               _loc7_ = _loc7_ + this.rowGap;
            }
            _loc6_ = _loc4_.next;
            if(!_loc6_ || param1 > _loc4_.rowIndex && param1 < _loc6_.rowIndex)
            {
      ...
      public function getPadRowBounds(param1:int) : Rectangle
      {
         ...
         var _loc4_:Number = _loc2_ >= 0?Number(this.getCellX(_loc2_,0)):Number(0);
         var _loc5_:Number = _loc2_ >= 0?Number(this.getCellY(_loc2_,0) + this.getRowHeight(_loc2_)):Number(0);
         _loc6_ = param1 - this.rowCount;
         var _loc7_:Number = _loc6_ > 0?Number((_loc6_ - 1) * this.rowGap):Number(0);
      ...
      public function getColumnBounds(param1:int) : Rectangle
      {
         ...
         var _loc3_:Number = this.getCellY(0,param1);
         var _loc4_:Number = this.getColumnWidth(param1);
         var _loc5_:Number = 0;
         if(this._rowCount > 0)
         {
            _loc5_ = this.getCellY(this._rowCount - 1,param1) + this.getRowHeight(this._rowCount - 1) - _loc3_;
         }
         return new Rectangle(_loc2_,_loc3_,_loc4_,_loc5_);
      }
      ...
      public function getRowIndexAt(param1:Number, param2:Number) : int
      {
         ...
         if(!this.variableRowHeight || this.rowList.length == 0)
         {
            ...
            return _loc3_ < this._rowCount?int(_loc3_):-1;
         }
         if(param2 == 0)
         {
      ...
      private function isYInRow(param1:Number, param2:Number, param3:spark.components.gridClasses.GridRowNode) : Boolean
      {
         var _loc4_:Number = param2 + this.getRowHeight(param3.rowIndex);
         if(param3.rowIndex != this.rowCount - 1)
         {
            _loc4_ = _loc4_ + this.rowGap;
         }
      ...
      private function getPrevRowIndexAt(param1:Number, param2:spark.components.gridClasses.GridRowNode, param3:Number) : int
      {
         var _loc8_:Number = NaN;
         var _loc10_:int = 0;
         var _loc4_:spark.components.gridClasses.GridRowNode = param2;
         var _loc5_:spark.components.gridClasses.GridRowNode = null;
         ...
         while(_loc4_)
         {
            ...
            {
               _loc8_ = _loc7_;
               _loc10_ = _loc4_.rowIndex - _loc5_.rowIndex;
               if(_loc10_ > 1)
               {
                  _loc8_ = _loc8_ - (_loc10_ - 1) * (this.defaultRowHeight + this.rowGap);
               }
            }
            if(_loc9_ < _loc7_ && _loc9_ >= _loc8_)
            {
               _loc6_ = _loc6_ - Math.ceil(Number(_loc7_ - _loc9_) / (this.defaultRowHeight + this.rowGap));
               break;
            }
            _loc7_ = _loc8_ - this.getRowHeight(_loc5_.rowIndex) - this.rowGap;
            _loc4_ = _loc4_.prev;
            _loc6_ = _loc4_.rowIndex;
         }
      ...
      private function getNextRowIndexAt(param1:Number, param2:spark.components.gridClasses.GridRowNode, param3:Number) : int
      {
         ...
         while(_loc4_)
         {
            ...
            _loc8_ = _loc8_ + this.getRowHeight(_loc4_.rowIndex);
            if(_loc4_.rowIndex != this.rowCount - 1)
            {
               _loc8_ = _loc8_ + this.rowGap;
            }
            _loc5_ = _loc4_.next;
            _loc9_ = _loc8_;
            if(!_loc5_)
            {
               ...
               _loc9_ = _loc9_ + (_loc11_ * (this.defaultRowHeight + this.rowGap) - this.rowGap + 1);
            }
            else
            {
               _loc11_ = _loc5_.rowIndex - _loc4_.rowIndex;
               _loc9_ = _loc9_ + (_loc11_ - 1) * (this.defaultRowHeight + this.rowGap);
            }
            if(_loc10_ >= _loc8_ && _loc10_ < _loc9_)
            {
               _loc6_ = _loc6_ + Math.ceil(Number(_loc10_ - _loc8_) / (this.defaultRowHeight + this.rowGap));
               break;
            }
            if(!_loc5_)
            {
      ...
      public function getColumnIndexAt(param1:Number, param2:Number) : int
      {
         ...
         for(; _loc4_ < this._columnCount; _loc4_++)
         {
            ...
            if(isNaN(_loc5_))
            {
               _loc5_ = this.typicalCellWidths[_loc4_];
               if(_loc5_ == 0)
               {
                  continue;
               }
            ...
            _loc3_ = _loc3_ - (_loc5_ + this.columnGap);
            if(_loc3_ < 0)
            {
               return _loc4_;
            }
      ...
      public function getContentWidth(param1:int = -1, param2:int = 0) : Number
      {
         ...
         var _loc3_:int = param1 == -1?int(this.columnCount - param2):int(param1);
         var _loc4_:Number = 0;
         var _loc5_:int = 0;
         var _loc6_:int = param2;
         for(; _loc6_ < this.columnCount && _loc5_ < _loc3_; _loc6_++)
         {
            if(_loc6_ >= this._columnWidths.length)
            {
               _loc4_ = _loc4_ + this.defaultColumnWidth;
               _loc5_++;
            }
            else
            {
               _loc7_ = this._columnWidths[_loc6_];
               if(isNaN(_loc7_))
               {
                  _loc7_ = this.typicalCellWidths[_loc6_];
                  if(_loc7_ == 0)
                  {
                     continue;
                  }
               ...
               if(isNaN(_loc7_))
               {
                  _loc7_ = this.defaultColumnWidth;
               }
         ...
         if(_loc5_ > 1)
         {
            _loc4_ = _loc4_ + (_loc5_ - 1) * this.columnGap;
         }
         return _loc4_;
      }
      ...
      {
         var _loc3_:int = param1 == -1?int(this.rowCount - param2):int(param1);
         var _loc4_:int = param1 == -1?int(this.rowCount):int(param2 + param1);
         var _loc5_:Number = 0;
         if(_loc3_ > 1)
         {
            _loc5_ = _loc5_ + (_loc3_ - 1) * this.rowGap;
         }
         if(!this.variableRowHeight || this.rowList.length == 0)
         {
            return _loc5_ + _loc3_ * this.defaultRowHeight;
         }
         var _loc6_:spark.components.gridClasses.GridRowNode = param2 == 0?this.rowList.first:this.rowList.findNearestLTE(param2);
         var _loc7_:int = 0;
         while(_loc6_ && _loc6_.rowIndex < _loc4_)
         {
            if(_loc6_.rowIndex < param2)
            {
               _loc6_ = _loc6_.next;
            }
            else
            {
               _loc5_ = _loc5_ + this.getRowHeight(_loc6_.rowIndex);
               _loc7_++;
               _loc6_ = _loc6_.next;
            }
         }
         _loc5_ = _loc5_ + (_loc3_ - _loc7_) * this.defaultRowHeight;
         return _loc5_;
      }
      ...
      public function getTypicalContentWidth(param1:int = -1, param2:int = 0) : Number
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = param2;
         while(_loc6_ < this.columnCount && _loc5_ < _loc3_)
         {
            _loc7_ = _loc6_ < this.columnCount?Number(this.typicalCellWidths[_loc6_]):Number(NaN);
            if(_loc7_ != 0)
            {
               if(isNaN(_loc7_))
               {
      ...
      public function getTypicalContentHeight(param1:int = -1, param2:int = 0) : Number
      {
         ...
         if(_loc3_ > 1)
         {
            _loc4_ = _loc4_ + (_loc3_ - 1) * this.rowGap;
         }
         if(!isNaN(this.defaultRowHeight))
         {
            return _loc4_ + _loc3_ * this.defaultRowHeight;
         }
         return 0;
      }
      ...
      public function clearRows(param1:int, param2:int) : void
      {
         ...
         var _loc3_:spark.components.gridClasses.GridRowNode = this.rowList.findNearestLTE(param1);
         var _loc4_:int = param1 + param2;
         if(_loc3_ && _loc3_.rowIndex < param1)
         {
            _loc3_ = _loc3_.next;
         }
         while(_loc3_ && _loc3_.rowIndex < _loc4_)
         {
            _loc5_ = _loc3_;
            _loc3_ = _loc3_.next;
      ...
      {
         var _loc6_:spark.components.gridClasses.GridRowNode = null;
         var _loc4_:Vector.<spark.components.gridClasses.GridRowNode> = this.removeRowsAt(param1,param3);
         var _loc5_:int = param2 - param1;
         for each(_loc6_ in _loc4_)
         {
            _loc6_.rowIndex = _loc6_.rowIndex + _loc5_;
         }
      ...
      private function insertRowsAt(param1:int, param2:int, param3:Vector.<spark.components.gridClasses.GridRowNode> = null) : void
      {
         var _loc5_:spark.components.gridClasses.GridRowNode = null;
         if(param1 < 0 || param2 <= 0)
         {
         ...
         var _loc4_:spark.components.gridClasses.GridRowNode = this.rowList.findNearestLTE(param1);
         if(_loc4_ && _loc4_.rowIndex < param1)
         {
            _loc4_ = _loc4_.next;
         }
         if(param3)
         ...
         while(_loc5_)
         {
            _loc5_.rowIndex = _loc5_.rowIndex + param2;
            _loc5_ = _loc5_.next;
         }
         this.rowCount = this.rowCount + param2;
         this.clearCachedNodes();
      }
      
      private function removeRowsAt(param1:int, param2:int) : Vector.<spark.components.gridClasses.GridRowNode>
      {
         var _loc6_:spark.components.gridClasses.GridRowNode = null;
         var _loc3_:Vector.<spark.components.gridClasses.GridRowNode> = new Vector.<spark.components.gridClasses.GridRowNode>();
         if(param1 < 0 || param2 <= 0)
         {
            return _loc3_;
         }
         ...
         while(_loc4_ && _loc4_.rowIndex < _loc5_)
         {
            _loc6_ = _loc4_;
            _loc3_.push(_loc6_);
            _loc4_ = _loc4_.next;
         ...
         while(_loc4_)
         {
            _loc4_.rowIndex = _loc4_.rowIndex - param2;
            _loc4_ = _loc4_.next;
         }
         this._rowCount = this._rowCount - param2;
         this.clearCachedNodes();
         return _loc3_;
      }
         ...
         switch(param1.kind)
         {
            ...
            case CollectionEventKind.UPDATE:
               ...
               while(_loc4_ < _loc3_)
               {
                  ...
                  if(_loc2_ && _loc2_.property == "visible")
                  {
