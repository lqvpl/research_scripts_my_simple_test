package spark.components.gridClasses
{
   public final class GridRowNode
   {
      ...
      public var next:spark.components.gridClasses.GridRowNode;
      
      public var prev:spark.components.gridClasses.GridRowNode;
      ...
      {
         var _loc1_:* = "";
         _loc1_ = _loc1_ + ("(" + this.rowIndex + ", " + this.maxCellHeight + ") ");
         _loc1_ = _loc1_ + (this.cellHeights + "\n");
         if(this.prev)
         {
            _loc1_ = _loc1_ + this.prev.rowIndex;
         }
         else
         {
            _loc1_ = _loc1_ + "null";
         ...
         if(this.next)
         {
            _loc1_ = _loc1_ + this.next.rowIndex;
         }
         else
         {
            _loc1_ = _loc1_ + "null";
