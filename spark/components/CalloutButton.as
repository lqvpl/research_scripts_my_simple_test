package spark.components
{
   ...
   public class CalloutButton extends Button
   {
      ...
      private var _callout:spark.components.Callout;
      ...
      public function get callout() : spark.components.Callout
      {
         return this._callout;
      }
      
      mx_internal function setCallout(param1:spark.components.Callout) : void
      {
      ...
      override protected function attachSkin() : void
      {
         ...
         {
            this.dropDown = new ClassFactory(spark.components.Callout);
         }
      }
      ...
      {
         var _loc3_:uint = 0;
         var _loc4_:spark.components.Callout = null;
         super.partAdded(param1,param2);
         if(param1 == "dropDown")
         {
            _loc3_ = 0;
            _loc4_ = param2 as spark.components.Callout;
      ...
      mx_internal function dropDownController_openHandler(param1:DropDownEvent) : void
      {
         if(!this.callout)
         {
            this.setCallout(createDynamicPartInstance("dropDown") as spark.components.Callout);
         }
         if(this.callout)
         {
