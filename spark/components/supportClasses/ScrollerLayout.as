package spark.components.supportClasses
{
   ...
   public class ScrollerLayout extends LayoutBase
   {
      ...
      private function getScroller() : Scroller
      {
         ...
         return _loc1_ && "hostComponent" in _loc1_?Object(_loc1_).hostComponent as Scroller:null;
      }
      ...
      private function hsbRequiredHeight() : Number
      {
         ...
         var _loc4_:Number = !!this.hsbVisible?Number(1):Number(this.hsbScaleY);
      ...
      private function hsbFits(param1:Number, param2:Number, param3:Boolean = true) : Boolean
      {
         ...
         if(this.vsbVisible && param3)
         {
            ...
            param1 = param1 - _loc5_.getPreferredBoundsWidth();
            param2 = param2 - _loc5_.getMinBoundsHeight();
         }
      ...
      private function vsbRequiredWidth() : Number
      {
         ...
         var _loc4_:Number = !!this.vsbVisible?Number(1):Number(this.vsbScaleX);
      ...
      private function vsbFits(param1:Number, param2:Number, param3:Boolean = true) : Boolean
      {
         ...
         if(this.hsbVisible && param3)
         {
            ...
            param1 = param1 - _loc5_.getMinBoundsWidth();
            param2 = param2 - _loc5_.getPreferredBoundsHeight();
         }
      ...
      override public function measure() : void
      {
         ...
         _loc5_ = _loc5_ + (!!_loc7_?this.hsbRequiredHeight():_loc2_);
         _loc4_ = _loc4_ + (!!_loc10_?this.vsbRequiredWidth():_loc2_);
         ...
         if(_loc12_)
         {
            if(_loc3_)
            {
               ...
               _loc20_ = _loc12_.getPreferredBoundsWidth();
               _loc21_ = _loc19_.x;
               _loc22_ = _loc12_.getLayoutBoundsWidth();
               _loc23_ = !isNaN(_loc22_) && _loc22_ + SDT > _loc21_;
               if(_loc8_ && !_loc7_ && _loc20_ + SDT <= _loc21_ && _loc23_)
               {
                  _loc4_ = _loc4_ + _loc22_;
               }
               else
               {
                  _loc4_ = _loc4_ + Math.max(_loc20_,!!_loc7_?Number(_loc6_.getMinBoundsWidth()):Number(0));
               }
               _loc24_ = _loc12_.getPreferredBoundsHeight();
               _loc25_ = _loc19_.y;
               _loc26_ = _loc12_.getLayoutBoundsHeight();
               _loc27_ = !isNaN(_loc26_) && _loc26_ + SDT > _loc25_;
               if(_loc11_ && !_loc10_ && _loc24_ + SDT <= _loc25_ && _loc27_)
               {
                  _loc5_ = _loc5_ + _loc26_;
               }
               else
               {
                  _loc5_ = _loc5_ + Math.max(_loc24_,!!_loc10_?Number(_loc9_.getMinBoundsHeight()):Number(0));
               }
            }
            else
            {
               _loc4_ = _loc4_ + _loc12_.getPreferredBoundsWidth();
               _loc5_ = _loc5_ + _loc12_.getPreferredBoundsHeight();
            }
         }
         var _loc13_:Number = _loc2_ * 2;
         var _loc14_:Number = _loc2_ * 2;
         var _loc15_:IUIComponent = _loc12_ as IUIComponent;
         var _loc16_:Number = !!_loc15_?Number(_loc15_.explicitWidth):Number(NaN);
         var _loc17_:Number = !!_loc15_?Number(_loc15_.explicitHeight):Number(NaN);
         if(!isNaN(_loc16_))
         {
      ...
      override public function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc11_:Number = !!_loc10_?Number(_loc10_.explicitWidth):Number(NaN);
         var _loc12_:Number = !!_loc10_?Number(_loc10_.explicitHeight):Number(NaN);
         var _loc13_:Number = !!isNaN(_loc11_)?Number(param1 - _loc7_ * 2):Number(_loc11_);
         var _loc14_:Number = !!isNaN(_loc12_)?Number(param2 - _loc7_ * 2):Number(_loc12_);
         ...
         switch(_loc3_.getStyle("horizontalScrollPolicy"))
         {
            ...
            case ScrollPolicy.AUTO:
               ...
               {
                  _loc17_ = true;
                  this._canScrollHorizontally = _loc8_ >= _loc13_ + SDT;
                  this.hsbVisible = _loc5_ && this._canScrollHorizontally;
               }
               break;
            default:
         ...
         switch(_loc3_.getStyle("verticalScrollPolicy"))
         {
            ...
            case ScrollPolicy.AUTO:
               ...
               {
                  _loc19_ = true;
                  this._canScrollVertically = _loc9_ >= _loc14_ + SDT;
                  this.vsbVisible = _loc6_ && this._canScrollVertically;
               }
               break;
            default:
         ...
         {
            _loc18_ = false;
            this.hsbVisible = _loc3_.horizontalScrollInProgress;
            _loc20_ = false;
            this.vsbVisible = _loc3_.verticalScrollInProgress;
         }
         if(isNaN(_loc11_))
         {
         ...
         if(this.vsbVisible && !this.hsbVisible && _loc17_ && _loc8_ >= _loc13_ + SDT)
         {
            this.hsbVisible = _loc21_ = this._canScrollHorizontally = true;
         }
         else if(!this.vsbVisible && this.hsbVisible && _loc19_ && _loc9_ >= _loc14_ + SDT)
         {
         ...
         if(this.hsbVisible && _loc18_ && (this.vsbVisible && _loc20_))
         {
            if(!(this.hsbFits(param1,param2) && this.vsbFits(param1,param2)))
            {
               ...
               {
                  if(this.removeCount < 2 && this.vsbFits(param1,param2,false))
                  {
                     this.removeCount++;
                     this.hsbVisible = false;
                  }
               ...
               {
                  if(this.removeCount < 2 && this.hsbFits(param1,param2,false))
                  {
                     this.removeCount++;
                     this.vsbVisible = false;
                  }
         ...
         if(this.hsbVisible)
         {
            ...
            _loc25_ = !!this.vsbVisible?Number(param1 - _loc6_.getPreferredBoundsWidth()):Number(param1);
         ...
         if(this.vsbVisible)
         {
            ...
            _loc27_ = !!this.hsbVisible?Number(param2 - _loc5_.getPreferredBoundsHeight()):Number(param2);
         ...
         if(this.invalidationCount < 2 && (this.vsbVisible != _loc16_ && _loc19_ || this.hsbVisible != _loc15_ && _loc17_))
         {
            ...
            if(_loc28_ && _loc28_.layout && _loc28_.layout.useVirtualLayout)
            {
