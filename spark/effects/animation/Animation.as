package spark.effects.animation
{
   ...
   public final class Animation
   {
      ...
      public function Animation(param1:Number = 500, param2:String = null, param3:Object = null, param4:Object = null)
      {
         ...
         {
            this.motionPaths = new <spark.effects.animation.MotionPath>[new spark.effects.animation.MotionPath(param2)];
            this.motionPaths[0].keyframes = new <Keyframe>[new Keyframe(0,param3),new Keyframe(param1,param4)];
         }
      }
      
      private static function addAnimation(param1:spark.effects.animation.Animation) : void
      {
         var _loc2_:int = 0;
         if(param1.motionPaths && param1.motionPaths.length > 0 && param1.motionPaths[0] && (param1.motionPaths[0].property == "width" || param1.motionPaths[0].property == "height"))
         {
            ...
            {
               spark.effects.animation.Animation(activeAnimations[_loc2_]).id = _loc2_;
               _loc2_++;
            }
         }
         else
      ...
      private static function removeAnimationAt(param1:int) : void
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:spark.effects.animation.Animation = null;
         if(param1 >= 0 && param1 < activeAnimations.length)
         {
            activeAnimations.splice(param1,1);
            _loc2_ = activeAnimations.length;
            _loc3_ = param1;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = spark.effects.animation.Animation(activeAnimations[_loc3_]);
               _loc4_.id--;
               _loc3_++;
            }
         }
      ...
      private static function removeAnimation(param1:spark.effects.animation.Animation) : void
      {
      ...
      {
         var _loc5_:* = false;
         var _loc6_:spark.effects.animation.Animation = null;
         var _loc7_:spark.effects.animation.Animation = null;
         var _loc8_:Number = NaN;
         var _loc2_:Number = intervalTime;
         intervalTime = Timeline.pulse();
         var _loc3_:int = activeAnimations.length;
         var _loc4_:int = 0;
         while(_loc4_ < activeAnimations.length)
         {
            _loc5_ = true;
            _loc6_ = spark.effects.animation.Animation(activeAnimations[_loc4_]);
            if(_loc6_)
            {
         ...
         {
            _loc7_ = spark.effects.animation.Animation(delayedStartAnims[0]);
            _loc8_ = delayedStartTimes[_loc7_];
      ...
      public function set animationTarget(param1:spark.effects.animation.IAnimationTarget) : void
      {
      ...
      private function doInterval() : Boolean
      {
         ...
         if(this._isPlaying || this._doSeek)
         {
            ...
            if(_loc3_ >= this.duration)
            {
               ...
               {
                  _loc4_ = _loc4_ + (this._playheadTime - this.duration) / (this.duration + this.repeatDelay);
               }
      ...
      private function addToDelayedAnimations(param1:Number) : void
      {
         ...
         {
            _loc5_ = delayedStartTimes[delayedStartAnims[_loc4_]];
            if(_loc2_ < _loc5_)
            {
               _loc3_ = _loc4_;
               break;
      ...
      public function play() : void
      {
         ...
         while(_loc1_ < this.motionPaths.length)
         {
            this.motionPaths[_loc1_].scaleKeyframes(this.duration);
            _loc1_++;
         }
         if(this._doReverse)
         {
      ...
      {
         var _loc1_:Number = delayedStartTimes[this];
         if(!isNaN(_loc1_))
         {
      ...
      private function stopAnimation() : void
      {
         ...
         if(this.id >= 0)
         {
            spark.effects.animation.Animation.removeAnimationAt(this.id);
            this.id = -1;
      ...
      private function repeat(param1:TimerEvent = null) : void
      {
         ...
         this.sendAnimationEvent(EffectEvent.EFFECT_REPEAT);
         this.sendUpdateEvent();
         spark.effects.animation.Animation.addAnimation(this);
      }
