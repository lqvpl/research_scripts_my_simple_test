package spark.effects.animation
{
   ...
   public class MotionPath
   {
      ...
      public function clone() : MotionPath
      {
         ...
         {
            _loc1_.keyframes = new Vector.<spark.effects.animation.Keyframe>();
            _loc2_ = 0;
      ...
      {
         var _loc3_:int = 0;
         var _loc4_:spark.effects.animation.Keyframe = null;
         var _loc2_:int = this.keyframes.length;
         while(_loc3_ < _loc2_)
         {
            _loc4_ = this.keyframes[_loc3_];
            _loc4_.timeFraction = _loc4_.time / param1;
            _loc3_++;
         }
      }
      ...
      public function getValue(param1:Number) : Object
      {
         ...
         var _loc7_:spark.effects.animation.Keyframe = null;
         ...
         var _loc2_:int = this.keyframes.length;
         if(_loc2_ == 2 && this.keyframes[1].timeFraction == 1)
         {
            _loc6_ = !!this.keyframes[1].easer?Number(this.keyframes[1].easer.ease(param1)):Number(param1);
         ...
         while(_loc5_ < _loc2_)
         {
            ...
            if(param1 >= _loc3_ && param1 < _loc7_.timeFraction)
            {
               _loc8_ = (param1 - _loc3_) / (_loc7_.timeFraction - _loc3_);
               _loc9_ = !!_loc7_.easer?Number(_loc7_.easer.ease(_loc8_)):Number(_loc8_);
               return this.interpolator.interpolate(_loc9_,_loc4_,_loc7_.value);
            }
            _loc3_ = _loc7_.timeFraction;
            _loc4_ = _loc7_.value;
            _loc5_++;
         }
