package spark.effects.interpolation
{
   ...
   public class MultiValueInterpolator implements spark.effects.interpolation.IInterpolator
   {
      ...
      public function MultiValueInterpolator(param1:spark.effects.interpolation.IInterpolator = null)
      {
      ...
      public function set elementInterpolator(param1:spark.effects.interpolation.IInterpolator) : void
      {
