package mx.collections
{
   ...
   public class ListCollectionView extends Proxy implements ICollectionView, mx.collections.IList, IMXMLObject
   {
      ...
      mx_internal static const VERSION:String = "4.13.0.20140701";
      ...
      private function addItemsToView(param1:Array, param2:int, param3:Boolean = true, param4:Boolean = true) : int
      {
         var _loc8_:int = 0;
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         ...
         var _loc5_:Array = !!this.localIndex?[]:param1;
         ...
         if(this.localIndex)
         {
            ...
            while(_loc10_ < _loc9_)
            {
               ...
               if(this.filterFunction != null)
               {
                  if(this.filterFunction(_loc11_))
                  {
                     if(this.sort)
                     {
                        if(param4 || param2 < 0)
                        {
                           _loc8_ = this.findItem(_loc11_,Sort.ANY_INDEX_MODE,true);
                        }
                        else
                        {
                           _loc8_ = param2;
                     ...
                     {
                        _loc8_ = this.getFilteredItemIndex(_loc11_);
                     }
                     if(_loc7_)
                     {
                        _loc6_ = _loc8_;
               ...
               {
                  _loc8_ = this.localIndex.length;
                  _loc6_ = _loc8_;
               }
               if(_loc8_ != -1)
               {
                  this.localIndex.splice(_loc8_++,0,_loc11_);
                  _loc5_.push(_loc11_);
               }
               _loc10_++;
            }
         }
         if(this.sort && this.sort.unique && this.sort.compareFunction(_loc11_,this.localIndex[_loc8_]) == 0)
         {
            _loc12_ = this.resourceManager.getString("collections","incorrectAddition");
            throw new CollectionViewError(_loc12_);
         }
         if(this.localIndex && _loc5_.length > 1)
         {
            _loc6_ = -1;
         }
         if(param3 && _loc5_.length > 0)
         {
            _loc13_ = new CollectionEvent(CollectionEvent.COLLECTION_CHANGE);
            _loc13_.kind = CollectionEventKind.ADD;
            _loc13_.location = _loc6_;
            _loc13_.items = _loc5_;
      ...
      private function handlePropertyChangeEvents(param1:Array) : void
      {
         ...
         var _loc16_:int = 0;
         var _loc17_:CollectionEvent = null;
         ...
         if(this.sort || this.filterFunction != null)
         {
            ...
            while(_loc5_ < _loc3_.length)
            {
               ...
               if(_loc4_.move)
               {
                  _loc15_ = this.hasSortProperty(_loc4_.property);
                  this.moveItemInView(_loc4_.item,_loc4_.item,_loc2_,_loc15_);
               }
               else
               {
            ...
            while(_loc7_ < _loc2_.length)
            {
               ...
               {
                  if(_loc2_[_loc7_] == _loc3_[_loc16_].item)
                  {
                     _loc6_ = _loc6_.concat(_loc3_[_loc16_].events);
                  }
                  _loc16_++;
               }
               _loc7_++;
         ...
         if(_loc2_.length > 0)
         {
            _loc17_ = new CollectionEvent(CollectionEvent.COLLECTION_CHANGE);
            _loc17_.kind = CollectionEventKind.UPDATE;
            _loc17_.items = _loc2_;
            this.dispatchEvent(_loc17_);
         }
      }
      
      private function hasSortProperty(param1:String) : Boolean
      {
         var _loc2_:SortField = null;
         if(this.sort)
         {
            for each(_loc2_ in this.sort.fields)
            {
      ...
      private function moveItemInView(param1:Object, param2:Boolean = true, param3:Array = null, param4:Boolean = true) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         ...
         if(this.localIndex)
         {
            _loc5_ = -1;
            _loc6_ = 0;
            while(_loc6_ < this.localIndex.length)
            {
               if(this.localIndex[_loc6_] == param1)
               {
                  _loc5_ = _loc6_;
                  break;
               }
            ...
            if(_loc5_ > -1)
            {
               this.localIndex.splice(_loc5_,1);
            }
            _loc7_ = this.addItemsToView([param1],_loc5_,false,param4);
            if(param2)
            {
               _loc8_ = new CollectionEvent(CollectionEvent.COLLECTION_CHANGE);
               _loc8_.items.push(param1);
               if(param3 && _loc7_ == _loc5_ && _loc7_ > -1)
               {
                  param3.push(param1);
                  return;
               }
               ...
               {
                  _loc8_.kind = CollectionEventKind.MOVE;
                  _loc8_.location = _loc7_;
                  _loc8_.oldLocation = _loc5_;
               }
               else if(_loc7_ > -1)
               {
                  _loc8_.kind = CollectionEventKind.ADD;
                  _loc8_.location = _loc7_;
               }
               else if(_loc5_ > -1)
               {
                  _loc8_.kind = CollectionEventKind.REMOVE;
                  _loc8_.location = _loc5_;
               }
               else
               {
                  param2 = false;
