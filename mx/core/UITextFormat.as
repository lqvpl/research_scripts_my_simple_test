package mx.core
{
   ...
   public class UITextFormat extends TextFormat
   {
      ...
      private function measure(param1:String, param2:Boolean, param3:Boolean) : TextLineMetrics
      {
         ...
         var _loc4_:* = false;
         var _loc5_:mx.core.IFlexModuleFactory = noEmbeddedFonts || !embeddedFontRegistry?null:embeddedFontRegistry.getAssociatedModuleFactory(font,bold,italic,this,this.moduleFactory,this.systemManager,this.useFTE);
         _loc4_ = _loc5_ != null;
         if(_loc5_ == null)
         {
