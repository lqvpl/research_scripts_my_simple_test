package mx.core
{
   ...
   public class Container extends UIComponent implements IContainer, IDataRenderer, IFocusManagerContainer, IListItemRenderer, IRawChildrenContainer, IChildList, IVisualElementContainer, INavigatorContent
   {
      ...
      {
         var _loc1_:mx.core.EdgeMetrics = this.borderMetrics;
      ...
      public function get viewMetricsAndPadding() : mx.core.EdgeMetrics
      {
         ...
         var _loc1_:mx.core.EdgeMetrics = this._viewMetricsAndPadding;
         var _loc2_:mx.core.EdgeMetrics = this.viewMetrics;
      ...
      override public function validateDisplayList() : void
      {
         ...
         if(this.blocker)
         {
            ...
            {
               _loc1_ = mx.core.EdgeMetrics.EMPTY;
            }
      ...
      {
         var _loc4_:mx.core.EdgeMetrics = this.viewMetrics;
         var _loc5_:Number = 0;
         if(!param3)
         {
      ...
      override public function set nestLevel(param1:int) : void
      {
         ...
         var _loc2_:int = super.nestLevel;
         ...
         if(this.contentPane)
         {
            ...
            _loc3_ = this.contentPane.numChildren;
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
               _loc5_ = this.contentPane.getChildAt(_loc4_) as ILayoutManagerClient;
               if(_loc5_)
               {
               ...
               {
                  _loc6_ = this.contentPane.getChildAt(_loc4_) as IUITextField;
                  if(_loc6_)
                  {
      ...
      mx_internal function getScrollableRect() : Rectangle
      {
         ...
         var _loc7_:mx.core.EdgeMetrics = this.viewMetrics;
      ...
      protected function scrollChildren() : void
      {
         ...
         var _loc1_:mx.core.EdgeMetrics = this.viewMetrics;
         var _loc2_:Number = 0;
         var _loc3_:Number = 0;
