package mx.core
{
   ...
   public class UIComponent extends FlexSprite implements IAutomationObject, IChildList, IConstraintClient, IDeferredInstantiationUIComponent, IFlexDisplayObject, IFlexModule, IInvalidating, ILayoutManagerClient, IPropertyChangeNotifier, IRepeaterClient, IStateClient, IAdvancedStyleClient, IToolTipManagerClient, IUIComponent, IValidatorListener, IVisualElement
   {
      ...
      protected function invalidateSystemManager() : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc4_ = _loc1_.getChildAt(_loc3_) as mx.core.UIComponent;
            if(_loc4_)
            {
      ...
      public function determineTextFormatFromStyles() : mx.core.UITextFormat
      {
         ...
         if(!_loc1_)
         {
            ...
            _loc1_ = new mx.core.UITextFormat(this.getNonNullSystemManager(),_loc2_);
      ...
      mx_internal function addOverlay(param1:uint, param2:RoundedRectangle = null) : void
      {
         if(!this.effectOverlay)
         {
            ...
            this.effectOverlay = new mx.core.UIComponent();
      ...
      mx_internal function getFontContext(param1:String, param2:Boolean, param3:Boolean, param4:* = undefined) : mx.core.IFlexModuleFactory
      {
         ...
         var _loc5_:mx.core.IEmbeddedFontRegistry = embeddedFontRegistry;
      ...
      protected function createInFontContext(param1:Class) : Object
      {
         ...
         var _loc8_:mx.core.IFlexModuleFactory = null;
         var _loc9_:Object = null;
      ...
      public function hasFontContextChanged() : Boolean
      {
         ...
         var _loc4_:* = false;
         var _loc5_:* = false;
         var _loc6_:mx.core.IFlexModuleFactory = null;
      ...
      public function getVisibleRect(param1:DisplayObject = null) : Rectangle
      {
         ...
         _loc2_ = !!this.$parent?this.$parent:this.parent;
         if(!_loc2_)
         {
      ...
      {
         var _loc1_:mx.core.AdvancedLayoutFeatures = null;
         _loc1_ = new mx.core.AdvancedLayoutFeatures();
         this._hasComplexLayoutMatrix = true;
