package mx.managers
{
   ...
   public class ToolTipManagerImpl extends EventDispatcher implements mx.managers.IToolTipManager2
   {
      ...
      private function mouseIsOver(param1:DisplayObject) : Boolean
      {
         ...
         if(!this.isVisibleParentsIncluded(param1))
         {
            return false;
         }
      ...
      private function isVisibleParentsIncluded(param1:DisplayObject) : Boolean
      {
         if(param1 == null)
         {
            return false;
         }
         return !!this.isTopLevelApplication(param1)?Boolean(param1.visible):param1.visible && this.isVisibleParentsIncluded(param1.parent);
      }
      
      private function isTopLevelApplication(param1:DisplayObject) : Boolean
      {
