package mx.managers
{
   ...
   public class FocusManager extends EventDispatcher implements IFocusManager
   {
      ...
      mx_internal function set lastFocus(param1:mx.managers.IFocusManagerComponent) : void
      {
      ...
      {
         return this.findFocusManagerComponent2(param1) as mx.managers.IFocusManagerComponent;
      }
      ...
      private function findFocusManagerComponent2(param1:InteractiveObject) : DisplayObject
      {
         try
         {
            while(param1)
            {
               if(param1 is mx.managers.IFocusManagerComponent && IFocusManagerComponent(param1).focusEnabled || param1 is ISWFLoader)
               {
                  return param1;
               }
      ...
      private function sortFocusableObjectsTabIndex() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.focusableObjects[_loc2_] as mx.managers.IFocusManagerComponent;
      ...
      {
         var _loc3_:Boolean = false;
         var _loc4_:mx.managers.IFocusManagerComponent = null;
         var _loc5_:DisplayObjectContainer = null;
         var _loc6_:Boolean = false;
         var _loc7_:IChildList = null;
         var _loc8_:int = 0;
         if(param1 is mx.managers.IFocusManagerComponent && !param2)
         {
            _loc3_ = false;
            if(param1 is mx.managers.IFocusManagerComponent)
            {
      ...
      private function isTabVisible(param1:DisplayObject) : Boolean
      {
         ...
         while(_loc3_ && _loc3_ != _loc2_)
         {
            ...
            if(_loc3_ is mx.managers.IFocusManagerComponent && !IFocusManagerComponent(_loc3_).hasFocusableChildren)
            {
               return false;
            }
      ...
      public function getNextFocusManagerComponent(param1:Boolean = false) : mx.managers.IFocusManagerComponent
      {
         ...
         return !!_loc2_?_loc2_.displayObject as mx.managers.IFocusManagerComponent:null;
      }
      ...
      {
         this.calculateCandidates = true;
         var _loc2_:mx.managers.IFocusManagerComponent = IFocusManagerComponent(param1.target);
