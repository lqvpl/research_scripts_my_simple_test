package mx.managers
{
   ...
   public class PopUpManagerImpl extends EventDispatcher implements mx.managers.IPopUpManager
   {
      ...
      mx_internal function hideModalWindow(param1:PopUpData, param2:Boolean = false) : void
      {
         ...
         var _loc7_:IActiveWindowManager = null;
         var _loc8_:Number = NaN;
         var _loc9_:Blur = null;
         var _loc10_:DynamicEvent = null;
         ...
         if(_loc4_)
         {
            ...
            _loc7_ = IActiveWindowManager(_loc6_.getImplementation("mx.managers::IActiveWindowManager"));
            if(_loc7_.numModalWindows == 1)
            {
               _loc8_ = _loc3_.getStyle("modalTransparencyBlur");
               if(_loc8_)
               {
                  _loc9_ = new Blur(param1.blurTarget);
                  _loc9_.blurXFrom = _loc9_.blurYFrom = _loc8_;
                  _loc9_.blurXTo = _loc9_.blurYTo = 0;
                  _loc9_.duration = _loc4_;
         ...
         {
            _loc10_ = new DynamicEvent("hideModalWindow",false,false);
            _loc10_.popUpData = param1;
            _loc10_.destroy = param2;
