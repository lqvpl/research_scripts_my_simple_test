package mx.binding
{
   ...
   public class FunctionReturnWatcher extends mx.binding.Watcher
   {
      ...
      public var parentWatcher:mx.binding.Watcher;
      ...
      {
         if(!(param1 is mx.binding.Watcher))
         {
      ...
      override protected function shallowClone() : mx.binding.Watcher
      {
