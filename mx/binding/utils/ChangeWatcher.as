package mx.binding.utils
{
   ...
   public class ChangeWatcher
   {
      ...
      private var next:mx.binding.utils.ChangeWatcher;
      ...
      public function ChangeWatcher(param1:Object, param2:Function, param3:Boolean = false, param4:mx.binding.utils.ChangeWatcher = null)
      {
         super();
         this.host = null;
      ...
      public static function watch(param1:Object, param2:Object, param3:Function, param4:Boolean = false, param5:Boolean = false) : mx.binding.utils.ChangeWatcher
      {
         var _loc6_:mx.binding.utils.ChangeWatcher = null;
         if(!(param2 is Array))
         {
            param2 = [param2];
         }
         if(param2.length > 0)
         {
            _loc6_ = new mx.binding.utils.ChangeWatcher(param2[0],param3,param4,watch(null,param2.slice(1),param3,param4));
