package mx.rpc.xml
{
   ...
   public class SimpleXMLEncoder
   {
      ...
      static function encodeDate(param1:Date, param2:String) : String
      {
         ...
         {
            _loc4_ = param1.getUTCHours();
            if(_loc4_ < 10)
            {
               _loc3_ = _loc3_.concat("0");
            }
            _loc3_ = _loc3_.concat(_loc4_,":");
            _loc4_ = param1.getUTCMinutes();
            if(_loc4_ < 10)
            {
               _loc3_ = _loc3_.concat("0");
            }
            _loc3_ = _loc3_.concat(_loc4_,":");
            _loc4_ = param1.getUTCSeconds();
            if(_loc4_ < 10)
            {
               _loc3_ = _loc3_.concat("0");
            }
            _loc3_ = _loc3_.concat(_loc4_,".");
            _loc4_ = param1.getUTCMilliseconds();
            if(_loc4_ < 10)
            {
