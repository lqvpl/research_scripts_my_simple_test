package mx.states
{
   ...
   public class SetStyle extends OverrideBase
   {
      ...
      override public function apply(param1:UIComponent) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:IStyleManager2 = null;
         ...
         if(_loc2_ != null)
         {
            ...
            _loc4_ = !!RELATED_PROPERTIES[this.name]?RELATED_PROPERTIES[this.name]:null;
            if(!applied)
            {
      ...
      override public function remove(param1:UIComponent) : void
      {
         ...
         if(_loc2_ != null && this.appliedTarget)
         {
            ...
            _loc3_ = !!RELATED_PROPERTIES[this.name]?RELATED_PROPERTIES[this.name]:null;
            if(_loc3_)
            {
               _loc4_ = 0;
