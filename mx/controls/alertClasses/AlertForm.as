package mx.controls.alertClasses
{
   ...
   public class AlertForm extends UIComponent implements IFontContextComponent
   {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc8_:Number = this.textField.getStyle("paddingTop");
         var _loc9_:Number = this.textField.getStyle("paddingBottom");
         var _loc10_:Number = param2 - this.buttons[0].height - _loc8_ - _loc9_;
         if(_loc7_ > _loc10_)
         {
            _loc7_ = _loc10_;
         }
         var _loc11_:TextLineMetrics = this.textField.getUITextFormat().measureText(this.textField.text);
         if(_loc7_ < _loc11_.height)
         {
            _loc7_ = _loc11_.height;
         }
