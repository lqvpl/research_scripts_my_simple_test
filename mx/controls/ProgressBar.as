package mx.controls
{
   ...
   public class ProgressBar extends UIComponent implements IFontContextComponent
   {
      ...
      public function set source(param1:Object) : void
      {
         ...
         if(this._source && this._source is IEventDispatcher)
         {
      ...
      override protected function createChildren() : void
      {
         ...
         if(!this._bar)
         {
            this._bar = new UIComponent();
            this._content.addChild(this._bar);
         }
         if(!this._barMask)
         {
            _loc1_ = getStyle("maskSkin");
            this._barMask = new _loc1_();
            this._barMask.visible = true;
            this._bar.addChild(DisplayObject(this._barMask));
            UIComponent(this._bar).mask = DisplayObject(this._barMask);
         }
         if(!this._labelField)
         {
            this._labelField = IUITextField(createInFontContext(UITextField));
            this._labelField.styleName = this;
            addChild(DisplayObject(this._labelField));
         }
      }
      ...
      override protected function commitProperties() : void
      {
         ...
         if(hasFontContextChanged() && this._labelField != null)
         {
            _loc1_ = getChildIndex(DisplayObject(this._labelField));
            removeChild(DisplayObject(this._labelField));
            this._labelField = IUITextField(createInFontContext(UITextField));
            this._labelField.styleName = this;
            addChildAt(DisplayObject(this._labelField),_loc1_);
         }
      ...
      override protected function measure() : void
      {
         ...
         var _loc6_:Number = this._track.measuredWidth;
         var _loc7_:Number = !!isNaN(_loc5_)?Number(this._track.measuredHeight):Number(_loc5_);
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         _loc12_ = !!isNaN(_loc12_)?Number(this._track.measuredHeight):Number(_loc12_);
         ...
         switch(this.labelPlacement)
         {
            case ProgressBarLabelPlacement.TOP:
               this._labelField.move(_loc9_,_loc10_);
               this._labelField.setActualSize(_loc14_,_loc15_);
               this._content.move(_loc9_,_loc10_ + _loc15_ + _loc4_);
               this.layoutContent(param1 - _loc9_ - _loc6_,_loc12_);
               break;
            case ProgressBarLabelPlacement.RIGHT:
               _loc16_ = param1 - _loc9_ - _loc6_ - _loc14_ - _loc3_;
               this._labelField.move(_loc9_ + _loc16_ + _loc3_,(param2 - _loc15_) / 2);
               this._labelField.setActualSize(_loc14_,_loc15_);
               this._content.move(_loc9_,_loc10_ + (_loc15_ - _loc12_) / 2);
               this.layoutContent(_loc16_,_loc12_);
               break;
            case ProgressBarLabelPlacement.LEFT:
               this._labelField.move(_loc9_,_loc10_ + (param2 - _loc15_) / 2);
               this._labelField.setActualSize(_loc14_,_loc15_);
               this._content.move(_loc9_ + _loc14_ + _loc3_,_loc10_ + (_loc15_ - _loc12_) / 2);
               this.layoutContent(param1 - _loc9_ - _loc14_ - _loc4_ - _loc6_,_loc12_);
               break;
            case ProgressBarLabelPlacement.CENTER:
               this._labelField.move((param1 - _loc14_) / 2,(param2 - _loc15_) / 2);
               this._labelField.setActualSize(_loc14_,_loc15_);
               this._content.move(_loc9_,_loc10_);
               this.layoutContent(param1 - _loc6_,param2 - _loc8_);
               break;
            default:
               this._labelField.move(_loc9_,_loc10_ + _loc12_ + _loc4_);
               this._labelField.setActualSize(_loc14_,_loc15_);
               this._content.move(_loc9_,_loc10_);
               this.layoutContent(param1 - _loc9_ - _loc6_,_loc12_);
         }
         if(this._barMask)
         {
            this._barMask.move(0,0);
            this._barMask.setActualSize(this._track.width,this._track.height);
         }
         this._labelField.text = this.getFullLabelText();
         this._indeterminateBar.visible = this._indeterminate;
         ...
         {
            this._determinateBar.setActualSize(this._track.width,this._track.height);
         }
         else
         {
            _loc17_ = Math.max(0,this._track.width * this.percentComplete / 100);
            this._determinateBar.setActualSize(_loc17_,this._track.height);
            this._determinateBar.x = this.direction == ProgressBarDirection.RIGHT?Number(0):Number(this._track.width - _loc17_);
         }
      }
      ...
      private function createTrack() : void
      {
         if(this._track)
         {
            this._content.removeChild(DisplayObject(this._track));
            this._track = null;
         }
         var _loc1_:Class = getStyle("trackSkin");
         if(_loc1_)
         {
            this._track = new _loc1_();
            if(this._track is ISimpleStyleClient)
            {
               ISimpleStyleClient(this._track).styleName = this;
            }
            this._content.addChildAt(DisplayObject(this._track),0);
         }
      }
      
      private function createBar() : void
      {
         if(this._determinateBar)
         {
            this._bar.removeChild(DisplayObject(this._determinateBar));
            this._determinateBar = null;
         }
         var _loc1_:Class = getStyle("barSkin");
         if(_loc1_)
         {
            this._determinateBar = new _loc1_();
            if(this._determinateBar is ISimpleStyleClient)
            {
               ISimpleStyleClient(this._determinateBar).styleName = this;
            }
            this._bar.addChild(DisplayObject(this._determinateBar));
         }
      }
      
      private function createIndeterminateBar() : void
      {
         if(this._indeterminateBar)
         {
            this._bar.removeChild(DisplayObject(this._indeterminateBar));
            this._indeterminateBar = null;
         }
         var _loc1_:Class = getStyle("indeterminateSkin");
         if(_loc1_)
         {
            this._indeterminateBar = new _loc1_();
            if(this._indeterminateBar is ISimpleStyleClient)
            {
               ISimpleStyleClient(this._indeterminateBar).styleName = this;
            }
            this._indeterminateBar.visible = false;
            this._bar.addChild(DisplayObject(this._indeterminateBar));
         }
      }
      ...
      private function layoutContent(param1:Number, param2:Number) : void
      {
         ...
         this._track.setActualSize(param1,param2);
         this._bar.move(0,0);
         this._determinateBar.move(0,0);
         this._indeterminateBar.setActualSize(param1 + getStyle("indeterminateMoveInterval"),param2);
      }
      ...
      {
         if(this._indeterminateBar.x < 1)
         {
            this._indeterminateBar.x = this._indeterminateBar.x + 1;
         }
         else
         {
            this._indeterminateBar.x = -(getStyle("indeterminateMoveInterval") - 2);
         }
      }
