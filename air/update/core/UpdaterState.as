package air.update.core
{
   ...
   public class UpdaterState
   {
      ...
      public function removePreviousStorageData(param1:File) : void
      {
         ...
         var _loc2_:File = param1.resolvePath(Constants.UPDATER_FOLDER + "/" + Constants.STATE_FILE);
         FileUtils.deleteFile(_loc2_);
         _loc2_ = param1.resolvePath(Constants.UPDATER_FOLDER + "/" + Constants.UPDATE_LOCAL_FILE);
         FileUtils.deleteFile(_loc2_);
         _loc2_ = param1.resolvePath(Constants.UPDATER_FOLDER + "/" + Constants.DESCRIPTOR_LOCAL_FILE);
         FileUtils.deleteFile(_loc2_);
