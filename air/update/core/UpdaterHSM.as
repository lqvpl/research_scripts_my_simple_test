package air.update.core
{
   ...
   public class UpdaterHSM extends HSM
   {
      ...
      protected function stateDownloading(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case DownloadErrorEvent.DOWNLOAD_ERROR:
               this.lastErrorEvent = ErrorEvent(param1.clone());
      ...
      public function getUpdateState() : int
      {
         ...
         switch(stateHSM)
         {
            case this.stateInitialized:
               _loc1_ = UpdateState.READY;
               break;
            case this.stateBeforeChecking:
               _loc1_ = UpdateState.BEFORE_CHECKING;
               break;
            case this.stateChecking:
               _loc1_ = UpdateState.CHECKING;
               break;
            case this.stateAvailable:
            case this.stateAvailableFile:
               _loc1_ = UpdateState.AVAILABLE;
               break;
            case this.stateDownloading:
               _loc1_ = UpdateState.DOWNLOADING;
               break;
            case this.stateDownloaded:
               _loc1_ = UpdateState.DOWNLOADED;
               break;
            case this.stateInstalling:
               _loc1_ = UpdateState.INSTALLING;
               break;
            case this.statePendingInstall:
               _loc1_ = UpdateState.PENDING_INSTALLING;
               break;
      ...
      protected function stateChecking(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case ProgressEvent.PROGRESS:
               break;
            case DownloadErrorEvent.DOWNLOAD_ERROR:
               this.lastErrorEvent = new StatusUpdateErrorEvent(StatusUpdateErrorEvent.UPDATE_ERROR,false,true,DownloadErrorEvent(param1).text,DownloadErrorEvent(param1).errorID,DownloadErrorEvent(param1).subErrorID);
               transition(this.stateErrored);
               break;
            case UpdateEvent.DOWNLOAD_COMPLETE:
               this.downloader = null;
      ...
      protected function stateUnpackaging(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case IOErrorEvent.IO_ERROR:
               this.unpackager.cancel();
               this.unpackager = null;
               this.lastErrorEvent = new StatusFileUpdateErrorEvent(StatusFileUpdateErrorEvent.FILE_UPDATE_ERROR,false,true,"",ErrorEvent(param1).errorID);
               transition(this.stateErrored);
         }
      }
      ...
      protected function stateErrored(param1:Event) : void
      {
         ...
         logger.finest("stateErrored: " + param1.type + " lastErrorEvent: " + this.lastErrorEvent);
         switch(param1.type)
         {
            case HSMEvent.ENTER:
               _loc2_ = false;
               ...
               {
                  _loc2_ = dispatchEvent(this.lastErrorEvent);
