package
{
   ...
   public class _com_enfluid_ltp_view_filterviews_AvgKCFilterViewWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _com_enfluid_ltp_view_filterviews_AvgKCFilterViewWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         AvgKCFilterView.watcherSetupUtil = new _com_enfluid_ltp_view_filterviews_AvgKCFilterViewWatcherSetupUtil();
      }
      ...
      public function setup(param1:Object, param2:Function, param3:Function, param4:Array, param5:Array) : void
      {
         ...
         param5[4] = new PropertyWatcher("avgKCFilterMax",{"propertyChange":true},[param4[1]],null);
         param5[3] = new PropertyWatcher("avgKCFilterMin",{"propertyChange":true},[param4[0]],null);
