package
{
   ...
   public class _com_enfluid_ltp_view_renderers_headers_ProxiesHeaderRendererWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _com_enfluid_ltp_view_renderers_headers_ProxiesHeaderRendererWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         ProxiesHeaderRenderer.watcherSetupUtil = new _com_enfluid_ltp_view_renderers_headers_ProxiesHeaderRendererWatcherSetupUtil();
      }
