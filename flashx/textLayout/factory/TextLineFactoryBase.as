package flashx.textLayout.factory
{
   ...
   public class TextLineFactoryBase
   {
      ...
      public function set truncationOptions(param1:flashx.textLayout.factory.TruncationOptions) : void
      {
      ...
      {
         if(param1 != flashx.textLayout.factory.TruncationOptions.NO_LINE_COUNT_LIMIT && _factoryComposer._lines.length > param1)
         {
            return false;
         }
      ...
      tlf_internal function computeLastAllowedLineIndex(param1:int) : void
      {
         ...
         if(param1 != flashx.textLayout.factory.TruncationOptions.NO_LINE_COUNT_LIMIT && param1 <= this._truncationLineIndex)
         {
