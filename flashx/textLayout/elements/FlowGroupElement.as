package flashx.textLayout.elements
{
   ...
   public class FlowGroupElement extends flashx.textLayout.elements.FlowElement
   {
      ...
      private static function getNestedArg(param1:Object, param2:uint) : flashx.textLayout.elements.FlowElement
      {
         return (param1 is Array?param1[param2]:param1) as flashx.textLayout.elements.FlowElement;
      }
      
      override public function deepCopy(param1:int = 0, param2:int = -1) : flashx.textLayout.elements.FlowElement
      {
         var _loc4_:flashx.textLayout.elements.FlowElement = null;
         var _loc6_:flashx.textLayout.elements.FlowElement = null;
         var _loc7_:flashx.textLayout.elements.FlowElement = null;
         if(param2 == -1)
         {
            param2 = textLength;
         }
      ...
      override public function getText(param1:int = 0, param2:int = -1, param3:String = "\n") : String
      {
         ...
         while(_loc6_ >= 0 && _loc6_ < this._numChildren && _loc5_ < param2)
         {
      ...
      {
         var _loc3_:flashx.textLayout.elements.FlowElement = null;
      ...
      public function set mxmlChildren(param1:Array) : void
      {
         ...
         {
            if(_loc3_ is flashx.textLayout.elements.FlowElement)
            {
      ...
      public function getChildIndex(param1:flashx.textLayout.elements.FlowElement) : int
      {
         var _loc4_:int = 0;
         var _loc5_:flashx.textLayout.elements.FlowElement = null;
         var _loc6_:int = 0;
      ...
      public function getChildAt(param1:int) : flashx.textLayout.elements.FlowElement
      {
      ...
      tlf_internal function getNextLeafHelper(param1:FlowGroupElement, param2:flashx.textLayout.elements.FlowElement) : FlowLeafElement
      {
         ...
         var _loc4_:flashx.textLayout.elements.FlowElement = this.getChildAt(_loc3_ + 1);
         return _loc4_ is FlowLeafElement?FlowLeafElement(_loc4_):FlowGroupElement(_loc4_).getFirstLeaf();
      }
      ...
      tlf_internal function getPreviousLeafHelper(param1:FlowGroupElement, param2:flashx.textLayout.elements.FlowElement) : FlowLeafElement
      {
         ...
         var _loc4_:flashx.textLayout.elements.FlowElement = this.getChildAt(_loc3_ - 1);
         return _loc4_ is FlowLeafElement?FlowLeafElement(_loc4_):FlowGroupElement(_loc4_).getLastLeaf();
      }
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:flashx.textLayout.elements.FlowElement = null;
      ...
      tlf_internal function removeBlockElement(param1:flashx.textLayout.elements.FlowElement, param2:ContentElement) : void
      {
      }
      
      tlf_internal function insertBlockElement(param1:flashx.textLayout.elements.FlowElement, param2:ContentElement) : void
      {
      }
      ...
      tlf_internal function addChildAfterInternal(param1:flashx.textLayout.elements.FlowElement, param2:flashx.textLayout.elements.FlowElement) : void
      {
         if(this._numChildren > 1)
         {
      ...
      tlf_internal function canOwnFlowElement(param1:flashx.textLayout.elements.FlowElement) : Boolean
      {
      ...
      public function replaceChildren(param1:int, param2:int, ... rest) : void
      {
         ...
         var _loc9_:flashx.textLayout.elements.FlowElement = null;
         var _loc10_:flashx.textLayout.elements.FlowElement = null;
         var _loc11_:int = 0;
         var _loc12_:Object = null;
         var _loc13_:flashx.textLayout.elements.FlowElement = null;
         var _loc14_:int = 0;
         var _loc15_:int = 0;
      ...
      public function addChild(param1:flashx.textLayout.elements.FlowElement) : flashx.textLayout.elements.FlowElement
      {
         this.replaceChildren(this._numChildren,this._numChildren,param1);
         return param1;
      }
      
      public function addChildAt(param1:uint, param2:flashx.textLayout.elements.FlowElement) : flashx.textLayout.elements.FlowElement
      {
         this.replaceChildren(param1,param1,param2);
         return param2;
      }
      
      public function removeChild(param1:flashx.textLayout.elements.FlowElement) : flashx.textLayout.elements.FlowElement
      {
      ...
      public function removeChildAt(param1:uint) : flashx.textLayout.elements.FlowElement
      {
         var _loc2_:flashx.textLayout.elements.FlowElement = this.getChildAt(param1);
      ...
      override public function splitAtPosition(param1:int) : flashx.textLayout.elements.FlowElement
      {
         var _loc2_:int = 0;
         var _loc3_:flashx.textLayout.elements.FlowElement = null;
