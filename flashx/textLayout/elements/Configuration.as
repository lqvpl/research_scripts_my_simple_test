package flashx.textLayout.elements
{
   ...
   public class Configuration implements flashx.textLayout.elements.IConfiguration
   {
      ...
      tlf_internal static function getCursorString(param1:flashx.textLayout.elements.IConfiguration, param2:String) : String
      {
      ...
      private function initialize() : void
      {
         ...
         _loc1_.marginLeft = FormatValue.INHERIT;
         _loc1_.marginRight = FormatValue.INHERIT;
         _loc1_.marginTop = FormatValue.INHERIT;
         _loc1_.marginBottom = FormatValue.INHERIT;
         _loc1_.borderLeftWidth = FormatValue.INHERIT;
         _loc1_.borderRightWidth = FormatValue.INHERIT;
         _loc1_.borderTopWidth = FormatValue.INHERIT;
         _loc1_.borderBottomWidth = FormatValue.INHERIT;
      ...
      public function clone() : Configuration
      {
         ...
         _loc1_._cursorFunction = this._cursorFunction;
         return _loc1_;
      }
      ...
      public function set shiftEnterLevel(param1:int) : void
      {
         this._shiftEnterLevel = param1;
      }
