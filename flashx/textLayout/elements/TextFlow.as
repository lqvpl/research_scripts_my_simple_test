package flashx.textLayout.elements
{
   ...
   public class TextFlow extends ContainerFormattedElement implements IEventDispatcher
   {
      ...
      public function TextFlow(param1:flashx.textLayout.elements.IConfiguration = null)
      {
         super();
         this.initializeForConstructor(param1);
      }
      
      private function initializeForConstructor(param1:flashx.textLayout.elements.IConfiguration) : void
      {
         if(param1 == null)
         {
      ...
      tlf_internal function getExplicitStyle(param1:Object) : TextLayoutFormat
      {
         ...
         {
            _loc2_ = (this._formatResolver as IExplicitFormatResolver).resolveExplicitFormat(param1);
            if(_loc2_ == null)
            {
               return null;
            }
            _loc3_ = _loc2_ as TextLayoutFormat;
            return !!_loc3_?_loc3_:new TextLayoutFormat(_loc2_);
         }
         return null;
      }
      ...
      tlf_internal function clearBackgroundManager() : void
      {
         ...
         {
            if(!flashx.textLayout.elements.BackgroundManager.BACKGROUND_MANAGER_CACHE)
            {
               flashx.textLayout.elements.BackgroundManager.BACKGROUND_MANAGER_CACHE = new Dictionary();
            }
            flashx.textLayout.elements.BackgroundManager.BACKGROUND_MANAGER_CACHE[this] = this._backgroundManager.getShapeRectArray().concat();
         }
      ...
      public function set formatResolver(param1:flashx.textLayout.elements.IFormatResolver) : void
      {
