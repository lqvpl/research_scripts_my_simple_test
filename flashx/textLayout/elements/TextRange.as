package flashx.textLayout.elements
{
   public class TextRange
   {
      ...
      public function TextRange(param1:flashx.textLayout.elements.TextFlow, param2:int, param3:int)
      {
         super();
      ...
      public function set textFlow(param1:flashx.textLayout.elements.TextFlow) : void
      {
         this._textFlow = param1;
      }
