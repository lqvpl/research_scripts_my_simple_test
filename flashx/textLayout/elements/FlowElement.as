package flashx.textLayout.elements
{
   ...
   public class FlowElement implements ITextLayoutFormat
   {
      ...
      public function setBorderWidth(param1:Number) : void
      {
         this.borderBottomWidth = param1;
         this.borderLeftWidth = param1;
         this.borderRightWidth = param1;
         this.borderTopWidth = param1;
      }
      
      public function setBorderColor(param1:uint) : void
      {
         this.borderBottomColor = param1;
         this.borderLeftColor = param1;
         this.borderRightColor = param1;
         this.borderTopColor = param1;
      }
      ...
      public function shallowCopy(param1:int = 0, param2:int = -1) : FlowElement
      {
         ...
         {
            _loc3_._format = new flashx.textLayout.elements.FlowValueHolder(this._format);
         }
         return _loc3_;
      }
      ...
      tlf_internal function setParentAndRelativeStart(param1:flashx.textLayout.elements.FlowGroupElement, param2:int) : void
      {
         this._parent = param1;
      ...
      tlf_internal function setParentAndRelativeStartOnly(param1:flashx.textLayout.elements.FlowGroupElement, param2:int) : void
      {
         this._parent = param1;
         this._parentRelativeStart = param2;
      }
      ...
      tlf_internal function get formatForCascade() : ITextLayoutFormat
      {
         ...
         if(_loc1_)
         {
            ...
            _loc3_ = _loc1_.getExplicitStyle(this);
            if(_loc2_ || _loc3_)
            {
               _loc4_ = this.format;
      ...
      tlf_internal function updateLengths(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         var _loc4_:flashx.textLayout.elements.FlowGroupElement = this._parent;
         if(_loc4_)
         {
      ...
      {
         this._format = !!param1._format?new flashx.textLayout.elements.FlowValueHolder(param1._format):null;
         this._computedFormat = null;
      }
