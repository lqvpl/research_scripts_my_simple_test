   ...
   public class ParaEdit
   {
      ...
      public static function insertText(param1:TextFlow, param2:int, param3:String, param4:Boolean) : SpanElement
      {
         ...
         while(_loc11_ != null)
         {
            ...
            if(_loc14_ == 0 && !_loc11_.acceptTextBefore() || !_loc11_.acceptTextAfter() && (_loc14_ == _loc11_.textLength || _loc14_ == _loc11_.textLength - 1 && _loc5_ == _loc7_.getLastLeaf()))
            {
               param4 = true;
               _loc5_ = _loc10_;
      ...
      public static function createImage(param1:FlowGroupElement, param2:int, param3:Object, param4:Object, param5:Object, param6:Object, param7:ITextLayoutFormat) : InlineGraphicElement
      {
         ...
         {
            _loc16_ = "source=";
            _loc17_ = _loc11_.indexOf(_loc16_,_loc12_.length);
            if(_loc17_ > 0)
            {
               _loc17_ = _loc17_ + _loc16_.length;
      ...
      public static function cacheStyleInformation(param1:TextFlow, param2:int, param3:int, param4:Array) : void
      {
         ...
         while(true)
         {
            ...
            param4.push(_loc8_);
            _loc7_ = _loc7_ - Math.min(_loc7_,_loc6_);
            if(_loc7_ == 0)
            {
               break;
            }
      ...
      public static function cacheContainerStyleInformation(param1:TextFlow, param2:int, param3:int, param4:Array) : void
      {
         ...
         if(param1.flowComposer)
         {
            ...
            _loc6_ = param1.flowComposer.findControllerIndexAtPosition(param3,true);
            if(_loc6_ == -1)
            {
               _loc6_ = param1.flowComposer.numControllers - 1;
            }
            while(_loc5_ <= _loc6_)
            {
               _loc7_ = param1.flowComposer.getControllerAt(_loc5_);
               _loc8_ = new Object();
               _loc8_.container = _loc7_;
               _loc8_.attributes = new TextLayoutFormat(_loc7_.format);
               param4.push(_loc8_);
               _loc5_++;
            }
         }
      ...
      public static function applyContainerStyleChange(param1:TextFlow, param2:int, param3:int, param4:ITextLayoutFormat, param5:ITextLayoutFormat) : void
      {
         ...
         var _loc10_:TextLayoutFormat = null;
         if(param1.flowComposer)
         {
            ...
            _loc7_ = param1.flowComposer.findControllerIndexAtPosition(param3,true);
            if(_loc7_ == -1)
            {
               _loc7_ = param1.flowComposer.numControllers - 1;
            }
            _loc8_ = param1.flowComposer.findControllerIndexAtPosition(param2,false);
            while(_loc6_ <= _loc7_)
            {
               _loc9_ = param1.flowComposer.getControllerAt(_loc6_);
               _loc10_ = new TextLayoutFormat(_loc9_.format);
               if(param4)
               {
                  _loc10_.apply(param4);
               }
               undefineDefinedFormats(_loc10_,param5);
               _loc9_.format = _loc10_;
               _loc6_++;
            }
         }
      }
