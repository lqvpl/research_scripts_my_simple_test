...
class DeleteTextMemento extends BaseMemento implements IMemento
{
   ...
   function DeleteTextMemento(param1:TextFlow, param2:int, param3:int)
   {
      ...
      while(_loc5_ && _loc5_.parent && (_loc5_.getAbsoluteStart() + _loc5_.textLength < param3 || _loc5_.getAbsoluteStart() == param2 && _loc5_.getAbsoluteStart() + _loc5_.textLength == param3))
      {
