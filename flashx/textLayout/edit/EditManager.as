package flashx.textLayout.edit
{
   ...
   public class EditManager extends SelectionManager implements IEditManager
   {
            ...
            switch(param1.charCode)
            {
               ...
               case Keyboard.ENTER:
                  if(textFlow.configuration.manageEnterKey)
                  {
                     ...
                     else if(param1.shiftKey && (!_loc2_ && textFlow.configuration.shiftEnterLevel > 0 || textFlow.configuration.shiftEnterLevel > 1))
                     {
                        if(overwriteMode)
                        {
                           this.overwriteText(" ");
      ...
      {
         param6 = this.defaultOperationState(param6);
         if(!param6)
         {
            return;
         }
      ...
      {
         var _loc4_:DeleteTextOperation = null;
         var _loc5_:int = 0;
         param1 = this.defaultOperationState(param1);
         if(!param1)
         {
         ...
         var _loc2_:FlowLeafElement = textFlow.findLeaf(param1.absoluteStart);
         ...
         {
            _loc5_ = NavigationUtil.nextAtomPosition(textFlow,absoluteStart);
            _loc4_ = new DeleteTextOperation(param1,new SelectionState(textFlow,absoluteStart,_loc5_,pointFormat),true);
         }
         else
         {
            _loc4_ = new DeleteTextOperation(param1,param1,false);
         }
         this.doOperation(_loc4_);
      }
      ...
      public function insertTableElement(param1:TableElement, param2:SelectionState = null) : void
      {
         param2 = this.defaultOperationState(param2);
         if(!param2)
         {
         ...
         var _loc3_:InsertTableElementOperation = new InsertTableElementOperation(param2,param1);
         this.doOperation(_loc3_);
      }
      ...
      public function insertText(param1:String, param2:SelectionState = null) : void
      {
         ...
         {
            this.pendingInsert.text = this.pendingInsert.text + param1;
         }
         else
         {
      ...
      {
         param5 = this.defaultOperationState(param5);
         if(!param5)
         {
            return null;
         }
      ...
      {
         param4 = this.defaultOperationState(param4);
         if(!param4)
         {
            return;
         }
