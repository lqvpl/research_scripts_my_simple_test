package flashx.textLayout.edit
{
   ...
   public class SelectionManager implements ISelectionManager
   {
      ...
      private static function computeSelectionIndexInContainer(param1:TextFlow, param2:ContainerController, param3:Number, param4:Number) : int
      {
         ...
         var _loc26_:ParagraphElement = null;
         ...
         var _loc33_:ParagraphElement = null;
         var _loc34_:TableDataCellElement = null;
         var _loc35_:FlowElement = null;
         var _loc36_:TextFlowLine = null;
         var _loc37_:TableElement = null;
         var _loc38_:TableRowElement = null;
         var _loc39_:TableRowElement = null;
         var _loc40_:TableDataCellElement = null;
         var _loc41_:int = 0;
         ...
         var _loc14_:TableDataCellElement = locateNearestCell(param2,param3,param4,param1.computedFormat.blockProgression,param1.computedFormat.direction);
         var _loc15_:Rectangle = null;
         var _loc16_:int = -1;
         if(_loc14_)
         {
            _loc26_ = _loc14_.getLastLeaf().getParagraph();
            if(_loc26_.getTextFlow() == param1)
            {
               return _loc26_.getAbsoluteStart() + _loc26_.textLength - 1;
            }
         }
         var _loc17_:int = -1;
         var _loc20_:int = param1.flowComposer.numLines - 1;
         while(_loc20_ >= 0)
         {
            _loc18_ = param1.flowComposer.getLineAt(_loc20_);
            if(_loc18_.controller != param2 || _loc18_.columnIndex != _loc13_)
            {
               if(_loc17_ != -1)
               {
                  _loc6_ = _loc20_ + 1;
            ...
            else if(!(_loc18_.absoluteStart < _loc7_ || _loc18_.absoluteStart >= _loc7_ + _loc8_))
            {
               _loc19_ = _loc18_.getTextLine();
               if(!(_loc19_ == null || _loc19_.parent == null))
               {
                  if(_loc17_ == -1)
                  {
                     _loc17_ = _loc20_;
                  }
                  _loc27_ = _loc19_.getBounds(DisplayObject(param2.container));
                  _loc28_ = !!_loc10_?Number(_loc27_.left):Number(_loc27_.bottom);
                  _loc29_ = -1;
                  if(_loc15_)
                  {
                     _loc31_ = !!_loc10_?Number(_loc15_.right):Number(_loc15_.top);
                     _loc29_ = (_loc28_ + _loc31_) / 2;
                  }
                  _loc30_ = !!_loc10_?_loc28_ > _loc12_:_loc28_ < _loc12_;
                  if(_loc30_ || _loc20_ == 0)
                  {
                     _loc32_ = _loc29_ != -1 && (!!_loc10_?_loc12_ < _loc29_:_loc12_ > _loc29_);
                     if(_loc18_.paragraph.isInTable())
                     {
                        if(_loc32_ && _loc20_ != _loc17_)
                        {
                           _loc33_ = _loc18_.paragraph;
                           _loc34_ = _loc33_.getTableDataCellElement();
                           _loc35_ = _loc34_.getLastLeaf();
                           _loc36_ = _loc35_.getParagraph().getTextBlock().lastLine.userData;
                           if(_loc18_ == _loc36_)
                           {
                              _loc37_ = _loc34_.getTable();
                              _loc38_ = _loc34_.parent as TableRowElement;
                              _loc39_ = _loc38_.getNextSibling() as TableRowElement;
                              if(_loc39_ && _loc34_)
                              {
                                 _loc40_ = _loc39_.getChildAt(_loc34_.colIndex) as TableDataCellElement;
                                 _loc6_ = param1.flowComposer.findLineIndexAtPosition(_loc40_.getFirstLeaf().getParagraph().getAbsoluteStart());
                              }
                           }
                           else
                           {
                     ...
                     {
                        _loc6_ = _loc32_ && _loc20_ != _loc17_?int(_loc20_ + 1):int(_loc20_);
                     }
                     break;
                  }
                  _loc15_ = _loc27_;
         ...
         var _loc21_:TextFlowLine = param1.flowComposer.getLineAt(_loc6_);
         var _loc22_:TextLine = _loc21_.getTextLine(true);
         param3 = param3 - _loc22_.x;
         param4 = param4 - _loc22_.y;
         var _loc23_:Boolean = false;
         var _loc24_:int = -1;
         if(_loc11_)
         {
            _loc24_ = _loc22_.atomCount - 1;
         }
         else if(_loc21_.absoluteStart + _loc21_.textLength >= _loc21_.paragraph.getAbsoluteStart() + _loc21_.paragraph.textLength)
         {
            if(_loc22_.atomCount > 1)
            {
               _loc24_ = _loc22_.atomCount - 2;
            }
         }
         else
         {
            _loc41_ = _loc21_.absoluteStart + _loc21_.textLength - 1;
            _loc42_ = _loc22_.textBlock.content.rawText.charAt(_loc41_);
            if(_loc42_ == " ")
            {
               if(_loc22_.atomCount > 1)
               {
            ...
            {
               _loc23_ = true;
               if(_loc22_.atomCount > 0)
               {
                  _loc24_ = _loc22_.atomCount - 1;
               }
            }
         }
         var _loc25_:Rectangle = _loc24_ > 0?_loc22_.getAtomBounds(_loc24_):new Rectangle(0,0,0,0);
         if(!_loc10_)
         {
            if(param3 < 0)
            {
            ...
            else if(param3 > _loc25_.x + _loc25_.width)
            {
               if(_loc23_)
               {
                  return _loc21_.absoluteStart + _loc21_.textLength - 1;
               }
               if(_loc25_.x + _loc25_.width > 0)
               {
                  param3 = _loc25_.x + _loc25_.width;
               }
            }
         }
         else if(param4 < 0)
         ...
         else if(param4 > _loc25_.y + _loc25_.height)
         {
            if(_loc23_)
            {
               return _loc21_.absoluteStart + _loc21_.textLength - 1;
            }
            if(_loc25_.y + _loc25_.height > 0)
            {
               param4 = _loc25_.y + _loc25_.height;
            }
         }
         _loc5_ = computeSelectionIndexInLine(param1,_loc22_,param3,param4);
         return _loc5_ != -1?int(_loc5_):int(_loc7_ + _loc8_);
      }
      
      private static function locateNearestCell(param1:ContainerController, param2:Number, param3:Number, param4:String, param5:String) : TableDataCellElement
      {
         var _loc10_:Rectangle = null;
         var _loc6_:int = 0;
         var _loc7_:ColumnState = param1.columnState;
         var _loc8_:Boolean = false;
         var _loc9_:TableDataCellElement = null;
         while(_loc6_ < _loc7_.cellCount - 1)
         {
            _loc9_ = _loc7_.getCellAt(_loc6_);
            _loc10_ = new Rectangle(_loc9_.x,_loc9_.y,_loc9_.width,_loc9_.height);
            if(_loc10_.contains(param2,param3))
            {
               _loc8_ = true;
               break;
            }
      ...
      public function set focusedSelectionFormat(param1:flashx.textLayout.edit.SelectionFormat) : void
      {
      ...
      public function set unfocusedSelectionFormat(param1:flashx.textLayout.edit.SelectionFormat) : void
      {
      ...
      public function set inactiveSelectionFormat(param1:flashx.textLayout.edit.SelectionFormat) : void
      {
      ...
      {
         var _loc2_:flashx.textLayout.edit.SelectionFormat = null;
         var _loc3_:flashx.textLayout.edit.SelectionFormat = null;
      ...
      {
         var _loc1_:flashx.textLayout.edit.Mark = new flashx.textLayout.edit.Mark(-1);
         this.marks.push(_loc1_);
         return _loc1_;
      }
      
      tlf_internal function removeMark(param1:flashx.textLayout.edit.Mark) : void
      {
      ...
      {
         var _loc4_:flashx.textLayout.edit.Mark = null;
         if(param2 == 0)
         {
            return;
         }
