package flashx.textLayout.property
{
   ...
   public class Property
   {
      ...
      public static function NewEnumStringProperty(param1:String, param2:String, param3:Boolean, param4:Vector.<String>, ... rest) : Property
      {
         ...
         _loc6_.addHandlers(sharedUndefinedHandler,new flashx.textLayout.property.EnumPropertyHandler(rest),sharedInheritEnumHandler);
         return _loc6_;
      }
      ...
      public static function NewIntOrEnumProperty(param1:String, param2:Object, param3:Boolean, param4:Vector.<String>, param5:int, param6:int, ... rest) : Property
      {
         ...
         _loc8_.addHandlers(sharedUndefinedHandler,new flashx.textLayout.property.EnumPropertyHandler(rest),new IntPropertyHandler(param5,param6),sharedInheritEnumHandler);
         return _loc8_;
      }
      ...
      {
         var _loc6_:Property = new Property(param1,param2,param3,param4);
         _loc6_.addHandlers(sharedUndefinedHandler,new flashx.textLayout.property.EnumPropertyHandler(rest),sharedUintHandler,sharedInheritEnumHandler);
         return _loc6_;
      }
      ...
      public static function NewNumberProperty(param1:String, param2:Number, param3:Boolean, param4:Vector.<String>, param5:Number, param6:Number) : Property
      {
         ...
         _loc7_.addHandlers(sharedUndefinedHandler,new flashx.textLayout.property.NumberPropertyHandler(param5,param6),sharedInheritEnumHandler);
         return _loc7_;
      }
      ...
      public static function NewNumberOrPercentOrEnumProperty(param1:String, param2:Object, param3:Boolean, param4:Vector.<String>, param5:Number, param6:Number, param7:String, param8:String, ... rest) : Property
      {
         ...
         _loc10_.addHandlers(sharedUndefinedHandler,new flashx.textLayout.property.EnumPropertyHandler(rest),new PercentPropertyHandler(param7,param8),new flashx.textLayout.property.NumberPropertyHandler(param5,param6),sharedInheritEnumHandler);
         return _loc10_;
      }
      ...
      public static function NewNumberOrPercentProperty(param1:String, param2:Object, param3:Boolean, param4:Vector.<String>, param5:Number, param6:Number, param7:String, param8:String) : Property
      {
         ...
         _loc9_.addHandlers(sharedUndefinedHandler,new PercentPropertyHandler(param7,param8),new flashx.textLayout.property.NumberPropertyHandler(param5,param6),sharedInheritEnumHandler);
         return _loc9_;
      }
      ...
      {
         var _loc8_:Property = new Property(param1,param2,param3,param4);
         _loc8_.addHandlers(sharedUndefinedHandler,new flashx.textLayout.property.EnumPropertyHandler(rest),new flashx.textLayout.property.NumberPropertyHandler(param5,param6),sharedInheritEnumHandler);
         return _loc8_;
      }
      ...
      {
         var _loc3_:flashx.textLayout.property.PropertyHandler = null;
         this._handlers = new Vector.<flashx.textLayout.property.PropertyHandler>(rest.length,true);
         var _loc2_:int = 0;
         while(_loc2_ < rest.length)
         {
            ...
            if(_loc3_ is flashx.textLayout.property.NumberPropertyHandler)
            {
               this._numberPropertyHandler = _loc3_ as flashx.textLayout.property.NumberPropertyHandler;
            }
            _loc2_++;
         }
      }
      
      public function findHandler(param1:Class) : flashx.textLayout.property.PropertyHandler
      {
         var _loc2_:flashx.textLayout.property.PropertyHandler = null;
      ...
      {
         var _loc1_:flashx.textLayout.property.NumberPropertyHandler = this.findHandler(flashx.textLayout.property.NumberPropertyHandler) as flashx.textLayout.property.NumberPropertyHandler;
         if(_loc1_)
         {
