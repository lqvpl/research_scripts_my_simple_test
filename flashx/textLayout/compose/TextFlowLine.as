package flashx.textLayout.compose
{
   ...
   public final class TextFlowLine implements IVerticalJustificationLine
   {
      ...
      tlf_internal function testLineVisible(param1:String, param2:int, param3:int, param4:int, param5:int) : int
      {
      ...
      tlf_internal function oldTestLineVisible(param1:String, param2:int, param3:int, param4:int, param5:int) : Boolean
      {
         if(param1 == BlockProgression.RL)
         {
