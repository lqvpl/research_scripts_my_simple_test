package flashx.textLayout.compose
{
   ...
   public class ParcelList
   {
      ...
      {
         var _loc1_:flashx.textLayout.compose.ParcelList = !!_sharedParcelList?_sharedParcelList:new flashx.textLayout.compose.ParcelList();
         _sharedParcelList = null;
         return _loc1_;
      }
      
      tlf_internal static function releaseParcelList(param1:flashx.textLayout.compose.ParcelList) : void
      {
         if(_sharedParcelList == null)
         {
            _sharedParcelList = param1 as flashx.textLayout.compose.ParcelList;
      ...
      public function getParcelAt(param1:int) : flashx.textLayout.compose.Parcel
      {
      ...
      public function addParcel(param1:Rectangle, param2:ContainerController, param3:int) : flashx.textLayout.compose.Parcel
      {
         var _loc4_:flashx.textLayout.compose.Parcel = this._numParcels == 0 && this._singleParcel?this._singleParcel.initialize(this._verticalText,param1.x,param1.y,param1.width,param1.height,param2,param3):new flashx.textLayout.compose.Parcel(this._verticalText,param1.x,param1.y,param1.width,param1.height,param2,param3);
      ...
      public function popParcel() : flashx.textLayout.compose.Parcel
      {
         this._numParcels--;
         return this._parcelArray.pop();
      }
      
      public function addTableCell2ColumnState(param1:ContainerController, param2:TableDataCellElement) : void
      {
      ...
      public function beginCompose(param1:flashx.textLayout.compose.IFlowComposer, param2:int, param3:int, param4:Boolean) : void
      {
         var _loc6_:int = 0;
      ...
      private function adjustForScroll(param1:ContainerController, param2:Boolean) : void
      {
         ...
         var _loc5_:flashx.textLayout.compose.Parcel = null;
