package flashx.textLayout.compose
{
   ...
   public class BaseCompose
   {
      ...
      private static function createAlignData(param1:flashx.textLayout.compose.TextFlowLine) : AlignData
      {
      ...
      tlf_internal static function computeNumberLineAlignment(param1:AlignData, param2:Number, param3:Number, param4:TextLine, param5:Number, param6:Number, param7:Number) : Number
      {
         ...
         {
            if(flashx.textLayout.compose.TextFlowLine.getNumberLineParagraphDirection(param4) == Direction.LTR)
            {
               _loc8_ = -(param4.textWidth + flashx.textLayout.compose.TextFlowLine.getListEndIndent(param4) + param6) - param1.textIndent;
            }
            else
            {
               _loc8_ = param2 + flashx.textLayout.compose.TextFlowLine.getListEndIndent(param4) + (flashx.textLayout.compose.TextFlowLine.getNumberLineInsideLineWidth(param4) - param4.textWidth) + (param5 - param6 + param7 - param3) + param1.textIndent;
            }
         }
         else if(param1.textAlign == TextAlign.RIGHT)
         {
            ...
            {
               _loc8_ = param2 + flashx.textLayout.compose.TextFlowLine.getListEndIndent(param4) + (flashx.textLayout.compose.TextFlowLine.getNumberLineInsideLineWidth(param4) - param4.textWidth) + param1.textIndent;
            }
         }
         else if(flashx.textLayout.compose.TextFlowLine.getNumberLineParagraphDirection(param4) == Direction.LTR)
         {
            _loc8_ = -(param4.textWidth + flashx.textLayout.compose.TextFlowLine.getListEndIndent(param4)) - param1.textIndent;
         }
         else
         {
            _loc8_ = param2 + flashx.textLayout.compose.TextFlowLine.getListEndIndent(param4) + (flashx.textLayout.compose.TextFlowLine.getNumberLineInsideLineWidth(param4) - param4.textWidth) + (param5 - param3) + param1.textIndent;
         }
         return _loc8_;
      }
      ...
      protected function releaseParcelList(param1:flashx.textLayout.compose.ParcelList) : void
      {
      }
      ...
      protected function initializeForComposer(param1:flashx.textLayout.compose.IFlowComposer, param2:int, param3:int, param4:int) : void
      {
         if(!_savedLineSlug)
         {
            this._lineSlug = new flashx.textLayout.compose.Slug();
      ...
      private function composeBlockElement(param1:FlowGroupElement, param2:int, param3:Boolean = false, param4:int = -1) : Boolean
      {
         var _loc5_:FlowElement = null;
         var _loc6_:Boolean = false;
         var _loc9_:FlowLeafElement = null;
         var _loc10_:ParagraphElement = null;
         var _loc11_:TableElement = null;
         ...
         var _loc18_:ListItemElement = null;
         var _loc19_:TableRowElement = null;
         var _loc7_:int = 0;
         if(param4 != -1)
         {
            _loc7_ = param4;
         ...
         if(!param3)
         {
            ...
            {
               _loc7_ = param1.findChildIndexAtPosition(this._curElementStart + this._curElementOffset - param2);
               _loc5_ = param1.getChildAt(_loc7_);
               param2 = param2 + _loc5_.parentRelativeStart;
               _loc9_ = this._textFlow.findLeaf(this._startComposePosition - 1);
               if(_loc9_)
               {
                  _loc10_ = _loc9_.getParagraph();
                  if(_loc10_ && _loc10_ != this._curElement.getParagraph())
                  {
                     if(_loc10_.paddingBottom != undefined)
                     {
                        this._parcelList.addTotalDepth(_loc10_.paddingBottom);
                     }
                  }
               }
               if(_loc5_ is TableElement)
               {
                  _loc5_ = this._curElement;
                  while(_loc5_ && !(_loc5_ is TableRowElement))
                  {
                     _loc5_ = _loc5_.parent;
                  }
                  _loc11_ = _loc5_.parent as TableElement;
                  _loc11_.totalRowDepth = 0;
                  _loc11_.numAcrossParcels = 0;
                  _loc11_.originParcelIndex = 0;
                  _loc11_.heightArray = [];
                  if(!this.composeBlockElement(_loc5_.parent,this._curElementStart,true,(_loc5_ as TableRowElement).rowIndex))
                  {
                     BackgroundManager.collectBlock(this._textFlow,_loc11_,this._parcelList,true);
                     return false;
                  }
                  _loc11_.totalRowDepth = _loc11_.totalRowDepth + (_loc11_.getEffectiveBorderBottomWidth() + _loc11_.computedFormat.cellSpacing);
                  _loc11_.height = _loc11_.totalRowDepth;
                  param2 = this._curElementStart;
                  _loc7_++;
                  if(!this.gotoParcel(_loc11_.numAcrossParcels,_loc11_.totalRowDepth))
                  {
                     return false;
                  }
                  this._atColumnStart = false;
                  this._parcelList.addTotalDepth(_loc11_.getEffectiveMarginBottom());
                  BackgroundManager.collectBlock(this._textFlow,_loc11_,this._parcelList,true);
               }
            }
         }
         var _loc8_:* = param2 == this._curElementStart + this._curElementOffset;
         while(_loc7_ < param1.numChildren && (param2 <= this._stopComposePos || !this.parcelList.atLast()))
         {
            _loc5_ = param1.getChildAt(_loc7_);
            if(!param3)
            {
               if(_loc5_.computedFormat.clearFloats != ClearFloats.NONE)
               {
                  _loc17_ = this._curParcel.applyClear(_loc5_.computedFormat.clearFloats,this._parcelList.totalDepth,_loc5_.computedFormat.direction);
                  this._parcelList.addTotalDepth(_loc17_);
                  this._verticalSpaceCarried = 0;
               }
               if(this._blockProgression == BlockProgression.RL)
               {
                  _loc13_ = _loc5_.getEffectivePaddingTop() + _loc5_.getEffectiveBorderTopWidth() + _loc5_.getEffectiveMarginTop();
                  _loc14_ = _loc5_.getEffectivePaddingBottom() + _loc5_.getEffectiveBorderBottomWidth() + _loc5_.getEffectiveMarginBottom();
                  _loc15_ = _loc5_.getEffectivePaddingRight() + _loc5_.getEffectiveBorderRightWidth() + _loc5_.getEffectiveMarginRight();
                  _loc16_ = _loc5_.getEffectivePaddingLeft() + _loc5_.getEffectiveBorderLeftWidth() + _loc5_.getEffectiveMarginLeft();
               }
               else
               {
                  _loc13_ = _loc5_.getEffectivePaddingLeft() + _loc5_.getEffectiveBorderLeftWidth() + _loc5_.getEffectiveMarginLeft();
                  _loc14_ = _loc5_.getEffectivePaddingRight() + _loc5_.getEffectiveBorderRightWidth() + _loc5_.getEffectiveMarginRight();
                  _loc15_ = _loc5_.getEffectivePaddingTop() + _loc5_.getEffectiveBorderTopWidth() + _loc5_.getEffectiveMarginTop();
                  _loc16_ = _loc5_.getEffectivePaddingBottom() + _loc5_.getEffectiveBorderBottomWidth() + _loc5_.getEffectiveMarginBottom();
               }
               this._parcelList.pushLeftMargin(_loc13_);
               this._parcelList.pushRightMargin(_loc14_);
               if(_loc8_ && _loc15_ > this._verticalSpaceCarried)
               {
                  this._parcelList.addTotalDepth(_loc15_ - this._verticalSpaceCarried);
               }
               this._verticalSpaceCarried = Math.max(_loc15_,0);
            }
            _loc12_ = _loc5_ as ParagraphElement;
            if(_loc12_)
            {
               if(!this._atColumnStart && _loc12_.computedFormat.columnBreakBefore == BreakStyle.ALWAYS)
               {
                  this.advanceToNextParcel();
               }
               if(!(this._atColumnStart && this._parcelList.currentParcel != null && this._parcelList.currentParcel.columnIndex == 0) && _loc12_.computedFormat.containerBreakBefore == BreakStyle.ALWAYS)
               {
                  this.advanceToNextContainer();
               }
               if(!this.composeParagraphElement(_loc12_,param2))
               {
                  BackgroundManager.collectBlock(this._textFlow,param1);
                  return false;
               }
               if(!(this._atColumnStart && this._parcelList.currentParcel != null && this._parcelList.currentParcel.columnIndex == 0) && _loc12_.computedFormat.containerBreakAfter == BreakStyle.ALWAYS)
               {
                  this.advanceToNextContainer();
               }
               if(!this._atColumnStart && _loc12_.computedFormat.columnBreakAfter == BreakStyle.ALWAYS)
               {
                  this.advanceToNextParcel();
               }
            }
            else if(_loc5_ is ListElement)
            {
               _loc6_ = this.composeBlockElement(FlowGroupElement(_loc5_),param2,param3);
               if(!_loc6_)
               {
                  BackgroundManager.collectBlock(this._textFlow,param1);
                  return false;
            ...
            else if(_loc5_ is ListItemElement)
            {
               _loc18_ = this._listItemElement;
               this._listItemElement = _loc5_ as ListItemElement;
               _loc6_ = this.composeBlockElement(FlowGroupElement(_loc5_),param2,param3);
               this._listItemElement = _loc18_;
               if(!_loc6_)
               {
                  BackgroundManager.collectBlock(this._textFlow,param1);
                  return false;
            ...
            else if(_loc5_ is TableElement)
            {
               if(!this.composeTableElement(_loc5_ as TableElement,param2,param3))
               {
                  return false;
               }
            }
            else if(_loc5_ is TableRowElement)
            {
               _loc19_ = _loc5_ as TableRowElement;
               _loc19_.rowIndex = _loc7_;
               if(!this.composeTableRowElement(param1 as TableElement,_loc19_,param2,param3))
               {
                  return false;
               }
            }
            else if(_loc5_ is TableDataCellElement)
            {
               if(!this.composeTableDataCellElement(param1 as TableRowElement,_loc5_ as TableDataCellElement,param2,param3))
               {
                  return false;
               }
            }
            else if(!this.composeBlockElement(FlowGroupElement(_loc5_),param2))
            {
               BackgroundManager.collectBlock(this._textFlow,param1);
               return false;
            }
            if(!param3)
            {
               if(_loc16_ > this._verticalSpaceCarried)
               {
                  this._parcelList.addTotalDepth(_loc16_ - this._verticalSpaceCarried);
               }
               this._verticalSpaceCarried = Math.max(_loc16_,0);
               this._parcelList.popLeftMargin(_loc13_);
               this._parcelList.popRightMargin(_loc14_);
               _loc8_ = true;
            }
            param2 = param2 + _loc5_.textLength;
            _loc7_++;
         }
         if(!(param1 is TableElement || param1 is TableRowElement || param1 is TableDataCellElement))
         {
            BackgroundManager.collectBlock(this._textFlow,param1);
         }
         return true;
      ...
      private function composeTableElement(param1:TableElement, param2:int, param3:Boolean) : Boolean
      {
         param1.numAcrossParcels = 0;
         param1.heightArray = [];
         param1.curRowIdx = 0;
         param1.outOfLastParcel = false;
         var _loc4_:Number = param1.computedFormat.marginLeft;
         var _loc5_:Number = param1.computedFormat.marginTop;
         param1.x = this._parcelList.currentParcel.x + _loc4_;
         param1.y = this._parcelList.totalDepth + (!!this._atColumnStart?_loc5_:this._firstLineDescentAndLeading + _loc5_);
         this._parcelList.addTotalDepth(param1.y - this._parcelList.totalDepth);
         this.serializeTableColumnWidth(param1);
         param1.originParcelIndex = this._parcelList.currentParcelIndex;
         var _loc6_:flashx.textLayout.compose.Parcel = this._parcelList.currentParcel;
         this._parcelList.addTotalDepth(param1.getEffectiveBorderTopWidth());
         param1.totalRowDepth = this._parcelList.totalDepth;
         if(!this.composeBlockElement(FlowGroupElement(param1),param2,true))
         {
            if(param1.outOfLastParcel)
            {
               BackgroundManager.collectBlock(this._textFlow,param1,this._parcelList,false,true);
            }
            return false;
         }
         param1.totalRowDepth = param1.totalRowDepth + (param1.getEffectiveBorderBottomWidth() + param1.computedFormat.cellSpacing);
         if(param1.numAcrossParcels == 0 && this._startComposePosition <= param1.getAbsoluteStart())
         {
            param1.height = param1.totalRowDepth - param1.y;
         }
         else
         {
            param1.height = param1.totalRowDepth;
         }
         var _loc7_:Number = param1.totalRowDepth;
         var _loc8_:int = param1.originParcelIndex + param1.numAcrossParcels;
         if(this._parcelList.getParcelAt(_loc8_).isTableParcel)
         {
            _loc7_ = this._parcelList.getParcelAt(--_loc8_).bottom;
         }
         if(!this.gotoParcel(_loc8_,_loc7_))
         {
            return false;
         }
         this._atColumnStart = false;
         this._parcelList.addTotalDepth(param1.getEffectiveMarginBottom());
         BackgroundManager.collectBlock(this._textFlow,param1,this._parcelList);
         return true;
      }
      
      private function composeTableRowElement(param1:TableElement, param2:TableRowElement, param3:int, param4:Boolean) : Boolean
      {
         var _loc12_:flashx.textLayout.compose.Parcel = null;
         var _loc13_:int = 0;
         var _loc14_:TableDataCellElement = null;
         var _loc15_:int = 0;
         var _loc16_:ParagraphElement = null;
         var _loc17_:TextBlock = null;
         var _loc18_:TextLine = null;
         param2.iMaxRowDepth = 0;
         param2.columnIndex = 0;
         param1.totalRowDepth = param1.totalRowDepth + param1.computedFormat.cellSpacing;
         var _loc5_:int = this._curParaStart;
         var _loc6_:int = this._curElementStart;
         var _loc7_:int = this._curParcelStart;
         var _loc8_:FlowLeafElement = this._curElement;
         var _loc9_:ParagraphElement = this._curParaElement;
         if(!this.composeBlockElement(FlowGroupElement(param2),param3,param4))
         {
            if(param2.beyondParcel)
            {
               _loc12_ = this._parcelList.getParcelAt(param1.originParcelIndex + param1.numAcrossParcels + 1);
               if(param1.curRowIdx == 0)
               {
                  if(!_loc12_ || _loc12_.isTableParcel)
                  {
                     param1.x = param1.computedFormat.marginLeft;
                     param1.y = param1.totalRowDepth;
                  }
               }
               _loc13_ = 0;
               while(_loc13_ < param2.numChildren)
               {
                  _loc14_ = param2.getChildAt(_loc13_) as TableDataCellElement;
                  _loc15_ = 0;
                  while(_loc15_ < _loc14_.numChildren)
                  {
                     _loc16_ = _loc14_.getChildAt(_loc15_) as ParagraphElement;
                     _loc17_ = _loc16_.getTextBlock();
                     this._parcelList.currentParcel.controller.clearFloatsAt(_loc16_.getAbsoluteStart());
                     _loc18_ = _loc17_.lastLine;
                     while(_loc18_)
                     {
                        _loc17_.releaseLines(_loc18_,_loc18_);
                        _loc18_.userData = null;
                        _loc18_.visible = false;
                        if(this._textFlow.backgroundManager)
                        {
                           this._textFlow.backgroundManager.removeLineFromCache(_loc18_);
                        }
                        _loc18_ = _loc17_.lastLine;
                     }
                     _loc16_.releaseTextBlock();
                     _loc15_++;
                  }
                  _loc13_++;
               }
               if(!_loc12_ || _loc12_.isTableParcel)
               {
                  param1.outOfLastParcel = true;
                  return false;
               }
               if(param1.curRowIdx > 0)
               {
                  param1.numAcrossParcels++;
                  param1.heightArray.push(0);
                  param1.totalRowDepth = _loc12_.y + param1.computedFormat.cellSpacing;
               }
               else if(param1.curRowIdx == 0)
               {
                  param1.originParcelIndex++;
                  param1.x = _loc12_.x + param1.computedFormat.marginLeft;
                  param1.y = _loc12_.y;
                  param1.totalRowDepth = _loc12_.y + param1.computedFormat.cellSpacing + param1.getEffectiveBorderTopWidth();
               }
               param2.beyondParcel = false;
               this._curParaStart = _loc5_;
               this._curElementStart = _loc6_;
               this._curParcelStart = _loc7_;
               this._curElement = _loc8_;
               this._curParaElement = _loc9_;
         ...
         var _loc10_:flashx.textLayout.compose.Parcel = this._parcelList.getParcelAt(param1.originParcelIndex + param1.numAcrossParcels);
         param2.parcelIndex = param1.originParcelIndex + param1.numAcrossParcels;
         param2.height = param2.iMaxRowDepth;
         param2.x = _loc10_.x;
         param2.y = param1.totalRowDepth;
         param1.totalRowDepth = param1.totalRowDepth + param2.height;
         if(param1.numAcrossParcels == 0 && this._startComposePosition <= param1.getAbsoluteStart())
         {
            param1.height = param1.totalRowDepth - param1.y;
         }
         ...
         param1.height = param1.height + param1.cellSpacing;
         var _loc11_:ContainerController = this._parcelList.getParcelAt(param2.parcelIndex).controller;
         _loc13_ = 0;
         while(_loc13_ < param2.numChildren)
         {
            _loc14_ = param2.getChildAt(_loc13_) as TableDataCellElement;
            _loc14_.height = param2.height;
            this._parcelList.addTableCell2ColumnState(_loc11_,_loc14_);
            _loc13_++;
         }
         BackgroundManager.collectBlock(this._textFlow,param2,this._parcelList);
         param1.curRowIdx++;
         return true;
      }
      
      private function composeTableDataCellElement(param1:TableRowElement, param2:TableDataCellElement, param3:int, param4:Boolean) : Boolean
      {
         var _loc9_:int = 0;
         var _loc5_:TableElement = param1.getTable();
         var _loc6_:flashx.textLayout.compose.Parcel = this._parcelList.getParcelAt(_loc5_.originParcelIndex + _loc5_.numAcrossParcels);
         param2.x = _loc6_.x + _loc5_.getColumnAt(param1.columnIndex).x;
         param2.y = _loc5_.totalRowDepth;
         param2.width = _loc5_.getColumnWidth(param1.columnIndex);
         param2.height = undefined;
         var _loc7_:Rectangle = new Rectangle(param2.x,param2.y,param2.width,8000);
         param2.parcelIndex = this._parcelList.numParcels();
         var _loc8_:flashx.textLayout.compose.Parcel = this._parcelList.addParcel(_loc7_,_loc6_.controller,_loc5_.originParcelIndex + _loc5_.numAcrossParcels);
         _loc8_.isTableParcel = true;
         if(!this.gotoParcel(param2.parcelIndex,0))
         {
            return false;
         }
         this._parcelList.addTotalDepth(param2.getEffectiveBorderTopWidth() + param2.computedFormat.cellPadding);
         this._parcelList.pushLeftMargin(param2.getEffectiveBorderLeftWidth() + param2.computedFormat.cellPadding);
         this._parcelList.pushRightMargin(param2.getEffectiveBorderRightWidth() + param2.computedFormat.cellPadding);
         if(!this.composeBlockElement(FlowGroupElement(param2),param3,param4))
         {
            return false;
         }
         this._parcelList.addTotalDepth(param2.getEffectiveBorderBottomWidth() + param2.computedFormat.cellPadding);
         this._parcelList.popLeftMargin(param2.getEffectiveBorderLeftWidth() + param2.computedFormat.cellPadding);
         this._parcelList.popRightMargin(param2.getEffectiveBorderRightWidth() + param2.computedFormat.cellPadding);
         param2.height = this._parcelList.totalDepth;
         if(param2.height > param1.iMaxRowDepth)
         {
            param1.iMaxRowDepth = param2.height;
         }
         param1.columnIndex++;
         if(_loc5_.totalRowDepth + param1.iMaxRowDepth > _loc6_.bottom)
         {
            param1.beyondParcel = true;
            _loc9_ = 0;
            while(_loc9_ < param1.columnIndex)
            {
               this._parcelList.popParcel();
               _loc9_++;
            }
            return false;
         }
      ...
      private function serializeTableColumnWidth(param1:TableElement) : void
      {
         ...
         var _loc2_:Number = this._parcelList.currentParcel.width;
         if(param1.tableWidth != undefined && param1.tableWidth < _loc2_)
         {
            param1.computedWidth = param1.tableWidth;
         }
         else
         {
            param1.computedWidth = _loc2_;
         }
         if(param1.computedFormat.marginLeft > 0)
         {
            param1.computedWidth = param1.computedWidth - param1.computedFormat.marginLeft;
         }
         param1.computedWidth = param1.computedWidth - param1.computedFormat.marginRight;
         var _loc3_:Number = param1.computedWidth - param1.getEffectiveBorderLeftWidth() - param1.getEffectiveBorderRightWidth() - (param1.column + 1) * param1.computedFormat.cellSpacing;
         var _loc4_:Number = param1.getEffectiveBorderLeftWidth() + param1.computedFormat.marginLeft;
         var _loc5_:int = 0;
         while(_loc5_ < param1.column)
         {
            _loc6_ = param1.getColumnWidth(_loc5_);
            _loc7_ = _loc6_ as String;
            if(_loc7_ && _loc7_.length != 0 && _loc7_.charAt(_loc7_.length - 1) == "%")
            {
               _loc6_ = Property.toNumberIfPercent(_loc6_) * _loc3_ / 100;
               if(_loc6_ >= 0)
               {
                  param1.setColumnWidth(_loc5_,_loc6_);
               }
            }
            _loc4_ = _loc4_ + param1.computedFormat.cellSpacing;
            param1.getColumnAt(_loc5_).x = _loc4_;
            _loc4_ = _loc4_ + _loc6_;
            _loc5_++;
         }
         _loc4_ = _loc4_ - (param1.computedFormat.marginLeft + param1.getEffectiveBorderLeftWidth() + param1.column * param1.computedFormat.cellSpacing);
         if(_loc4_ - _loc3_ > 1)
         {
            _loc8_ = _loc3_ / param1.column;
            _loc9_ = 0;
            while(_loc9_ < param1.column)
            {
               param1.setColumnWidth(_loc9_,_loc8_);
               param1.getColumnAt(_loc9_).x = param1.getEffectiveBorderLeftWidth() + param1.computedFormat.marginLeft + (_loc9_ + 1) * param1.computedFormat.cellSpacing + _loc9_ * _loc8_;
               _loc9_++;
            }
         }
         else if(_loc4_ < _loc3_)
         {
            _loc10_ = param1.getColumnWidth(param1.column - 1);
            param1.setColumnWidth(param1.column - 1,_loc10_ + _loc3_ - _loc4_);
         }
      }
      ...
      public function composeTextFlow(param1:TextFlow, param2:int, param3:int) : int
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc9_:flashx.textLayout.compose.TextFlowLine = null;
         var _loc10_:flashx.textLayout.compose.Parcel = null;
         ...
         if(ContainerController.startComposeFromBeginning)
         {
         ...
         var _loc4_:Dictionary = this._startController.interactiveObjects;
         var _loc5_:Array = this._startController.oldInteractiveObjects;
         _loc5_.splice(0);
         for each(_loc6_ in _loc4_)
         {
            if(_loc6_ && (_loc6_ as FlowElement).getAbsoluteStart() >= this._startComposePosition)
            {
               _loc5_.push(_loc4_[_loc6_]);
               delete _loc4_[_loc6_];
            }
         }
         _loc7_ = this._flowComposer.getControllerIndex(this._startController) + 1;
         while(_loc7_ <= param3)
         {
            _loc4_ = this._flowComposer.getControllerAt(_loc7_).interactiveObjects;
            for each(_loc6_ in _loc4_)
            {
               if(_loc6_)
               {
            ...
            this._flowComposer.getControllerAt(_loc7_).clearCompositionResults();
            _loc7_++;
         }
         if(this._startComposePosition <= this._startController.absoluteStart || !this.advanceToComposeStartPosition())
         {
            ...
            {
               _loc8_ = this._flowComposer.findLineIndexAtPosition(this._startComposePosition - 1);
               _loc9_ = this._flowComposer.getLineAt(_loc8_);
               this._previousLine = _loc9_.getTextLine(true);
            }
            this.advanceToNextParcel();
            if(this._curParcel)
            {
         ...
         {
            _loc10_ = this.parcelList.getParcelAt(this.parcelList.currentParcelIndex + 1);
            if(this.parcelList.currentParcel.isTableParcel && (_loc10_ && _loc10_.isTableParcel || this.parcelList.currentParcelIndex == this.parcelList.numParcels() - 1))
            {
               this._correctTextLength = true;
            }
            this.advanceToNextParcel();
      ...
      private function advanceToComposeStartPosition() : Boolean
      {
         ...
         var _loc2_:flashx.textLayout.compose.TextFlowLine = this._flowComposer.getLineAt(_loc1_);
         ...
         this.calculateLeadingParameters(_loc4_,_loc5_,flashx.textLayout.compose.TextFlowLine.findNumberLine(this._curLine.getTextLine()));
         if(this._startComposePosition == this._curElement.getParagraph().getAbsoluteStart())
         {
            this._previousLine = null;
         }
      ...
      {
         var _loc4_:flashx.textLayout.compose.TextFlowLine = null;
      ...
      tlf_internal function computeTextFlowLineMinimumLogicalTop(param1:flashx.textLayout.compose.TextFlowLine, param2:TextLine) : Number
      {
         var _loc3_:int = 0;
      ...
      protected function composeParagraphElementIntoLines() : Boolean
      {
         ...
         while(_loc1_)
         {
            ...
            _loc8_ = flashx.textLayout.compose.TextFlowLine.findNumberLine(_loc2_);
            _loc9_ = _loc8_ && flashx.textLayout.compose.TextFlowLine.getNumberLineListStylePosition(_loc8_) == ListStylePosition.OUTSIDE || _loc7_ == TextAlign.CENTER || _loc7_ == TextAlign.RIGHT;
            if(Configuration.playerEnablesArgoFeatures)
            {
               if(_loc2_["hasTabs"])
               {
                  if(this._curParaFormat.direction == Direction.LTR)
                  {
                     if(!_loc8_ || flashx.textLayout.compose.TextFlowLine.getNumberLineListStylePosition(_loc8_) == ListStylePosition.INSIDE)
                     {
                        _loc9_ = false;
                     }
            ...
            else
            {
               ...
               if(this._curElementOffset >= this._curElement.textLength)
               {
                  do
                  {
                     ...
                     {
                        _loc14_ = this._curElement;
                        while(_loc14_ && _loc14_ != this._curParaElement)
                        {
                           if(_loc14_ is LinkElement)
                           {
                              this._curInteractiveObjects[_loc14_] = _loc14_;
                           }
                           else if(_loc14_.hasActiveEventMirror())
                           {
                              this._curInteractiveObjects[_loc14_] = _loc14_;
                           }
                           _loc14_ = _loc14_.parent;
                        }
                     }
      ...
      protected function composeInlineGraphicElement(param1:InlineGraphicElement, param2:TextLine) : Boolean
      {
         ...
         {
            _loc6_ = param1;
            while(_loc6_ && _loc6_ != this._curParaElement)
            {
               if(_loc6_ is LinkElement)
               {
                  this._curInteractiveObjects[_loc6_] = _loc6_;
               }
               else if(_loc6_.hasActiveEventMirror())
               {
                  this._curInteractiveObjects[_loc6_] = _loc6_;
               }
      ...
      protected function composeFloat(param1:InlineGraphicElement, param2:Boolean) : Boolean
      {
         ...
         if(_loc10_)
         {
            ...
            if(_loc3_)
            {
               this._workingContentExtent = Math.max(this._workingContentExtent,_loc12_.bottom + param1.getEffectivePaddingLeft() + param1.getEffectivePaddingRight());
               this._workingContentHeight = Math.max(this._workingContentHeight,_floatSlug.depth + _loc12_.width + param1.getEffectivePaddingTop() + param1.getEffectivePaddingBottom());
            ...
            {
               this._workingContentExtent = Math.max(this._workingContentExtent,_loc12_.right + param1.getEffectivePaddingLeft() + param1.getEffectivePaddingRight());
               this._workingContentHeight = Math.max(this._workingContentHeight,_floatSlug.depth + _loc12_.height + param1.getEffectivePaddingTop() + param1.getEffectivePaddingBottom());
      ...
      private function getRightSideGap(param1:flashx.textLayout.compose.TextFlowLine, param2:Boolean) : Number
      {
         var _loc6_:TextLine = null;
         ...
         if(_loc4_.direction == Direction.RTL && param1.location & TextFlowLineLocation.FIRST)
         {
            ...
            if(param1.hasNumberLine && _loc3_.getParentByType(ListItemElement).computedFormat.listStylePosition == ListStylePosition.INSIDE)
            {
               ...
               _loc7_ = flashx.textLayout.compose.TextFlowLine.findNumberLine(_loc6_);
               _loc5_ = _loc5_ + flashx.textLayout.compose.TextFlowLine.getNumberLineInsideLineWidth(_loc7_);
            }
         }
         do
         {
            _loc5_ = _loc5_ + (this._blockProgression == BlockProgression.TB?_loc3_.getEffectivePaddingRight() + _loc3_.getEffectiveBorderRightWidth() + _loc3_.getEffectiveMarginRight():_loc3_.getEffectivePaddingBottom() + _loc3_.getEffectiveBorderBottomWidth() + _loc3_.getEffectiveMarginBottom());
      ...
      private function getLeftSideGap(param1:flashx.textLayout.compose.TextFlowLine) : Number
      {
         ...
         if(_loc3_.direction == Direction.LTR && param1.location & TextFlowLineLocation.FIRST)
         {
            ...
            if(param1.hasNumberLine && _loc2_.getParentByType(ListItemElement).computedFormat.listStylePosition == ListStylePosition.INSIDE)
            {
               ...
               _loc6_ = flashx.textLayout.compose.TextFlowLine.findNumberLine(_loc5_);
               _loc4_ = _loc4_ + flashx.textLayout.compose.TextFlowLine.getNumberLineInsideLineWidth(_loc6_);
            }
         }
         do
         {
            _loc4_ = _loc4_ + (this._blockProgression == BlockProgression.TB?_loc2_.getEffectivePaddingLeft() + _loc2_.getEffectiveBorderLeftWidth() + _loc2_.getEffectiveMarginLeft():_loc2_.getEffectivePaddingTop() + _loc2_.getEffectiveBorderTopWidth() + _loc2_.getEffectiveMarginTop());
      ...
      private function calculateLineAlignmentAndBounds(param1:TextLine, param2:TextLine, param3:AlignData) : AlignData
      {
         ...
         {
            _loc4_ = this.calculateLineWidthExplicit(param1);
         }
         ...
         if(param3)
         {
            ...
            if(this._blockProgression == BlockProgression.TB)
            {
               if(!this._measuring)
               {
                  ...
                  if(param2 && flashx.textLayout.compose.TextFlowLine.getNumberLineListStylePosition(param2) == ListStylePosition.OUTSIDE)
                  {
         ...
         if(!param3)
         {
            ...
            if(param2)
            {
               ...
               if(flashx.textLayout.compose.TextFlowLine.getNumberLineListStylePosition(param2) == ListStylePosition.OUTSIDE)
               {
                  _loc15_ = _loc14_ + flashx.textLayout.compose.TextFlowLine.getNumberLineInsideLineWidth(param2);
      ...
      protected function fitLineToParcel(param1:TextLine, param2:Boolean, param3:TextLine) : Boolean
      {
         ...
         while(true)
         {
            ...
            {
               this.advanceToNextParcel();
               if(!this._curLine || this._parcelList.atEnd() || this._parcelList.currentParcel.isTableParcel)
               {
                  break;
               }
         ...
         if(param2)
         {
            if(param3)
            {
               flashx.textLayout.compose.TextFlowLine.initializeNumberLinePosition(param3,this._listItemElement,this._curParaElement,param1.textWidth);
            }
      ...
      protected function calculateLeadingParameters(param1:FlowLeafElement, param2:int, param3:TextLine = null) : Number
      {
         ...
         if(param3)
         {
            _loc4_ = flashx.textLayout.compose.TextFlowLine.getNumberLineSpanFormat(param3);
         }
      ...
      protected function finishComposeLine(param1:TextLine, param2:TextLine) : void
      {
         ...
         else
         {
            ...
            if(_loc10_ == BaselineOffset.ASCENT)
            {
               ...
               if(param2)
               {
                  _loc3_ = _loc3_ + Math.max(_loc13_,flashx.textLayout.compose.TextFlowLine.getTextLineTypographicAscent(param2,null,0,0));
               }
               else
               {
         ...
         this._firstLineDescentAndLeading = this._blockProgression == BlockProgression.RL?Number(-_loc3_):Number(_loc3_ - param1.ascent);
         _loc4_ = _loc4_ + this._firstLineDescentAndLeading;
      ...
      private function applyTextAlign(param1:Number) : void
      {
         ...
         if(this._blockProgression == BlockProgression.TB)
         {
            for each(_loc5_ in this._alignLines)
            {
               ...
               {
                  _loc4_ = _loc2_.userData as flashx.textLayout.compose.TextFlowLine;
                  if(_loc4_)
                  {
                     _loc4_.x = _loc6_;
                  }
               ...
               _loc3_ = flashx.textLayout.compose.TextFlowLine.findNumberLine(_loc2_);
               if(_loc3_ && flashx.textLayout.compose.TextFlowLine.getNumberLineListStylePosition(_loc3_) == ListStylePosition.OUTSIDE)
               {
                  ...
                  _loc12_ = _loc12_ + flashx.textLayout.compose.TextFlowLine.getNumberLineInsideLineWidth(_loc3_);
      ...
      protected function commitLastLineState(param1:flashx.textLayout.compose.TextFlowLine) : void
      {
      ...
      protected function doVerticalAlignment(param1:Boolean, param2:flashx.textLayout.compose.Parcel) : void
      {
      }
      ...
      protected function finishParcel(param1:ContainerController, param2:flashx.textLayout.compose.Parcel) : Boolean
      {
      ...
      protected function finishController(param1:ContainerController) : void
      {
         ...
         var _loc3_:ContainerController = this._flowComposer.getControllerAt(this._flowComposer.getControllerIndex(param1) + 1);
         if(_loc3_ && _loc3_.absoluteStart != 0 && this._correctTextLength)
         {
            _loc2_ = _loc3_.absoluteStart - param1.absoluteStart;
         }
         if(_loc2_ != 0)
         {
            _loc4_ = param1.getTotalPaddingLeft();
            _loc5_ = param1.getTotalPaddingTop();
            _loc6_ = param1.getTotalPaddingRight();
            _loc7_ = param1.getTotalPaddingBottom();
            if(this._blockProgression == BlockProgression.TB)
            {
               if(this._controllerLeft > 0)
               {
                  if(this._controllerLeft < _loc4_)
                  {
                     this._controllerLeft = 0;
                  }
                  else
                  {
                     this._controllerLeft = this._controllerLeft - _loc4_;
                  }
               }
               if(this._controllerTop > 0)
               {
                  if(this._controllerTop < _loc5_)
                  {
                     this._controllerTop = 0;
                  }
                  else
                  {
                     this._controllerTop = this._controllerTop - _loc5_;
                  }
               }
               if(isNaN(param1.compositionWidth))
               {
                  this._controllerRight = this._controllerRight + _loc6_;
               }
               else if(this._controllerRight < param1.compositionWidth)
               {
                  if(this._controllerRight > param1.compositionWidth - _loc6_)
                  {
               ...
               this._controllerBottom = this._controllerBottom + _loc7_;
            }
            else
            {
               this._controllerLeft = this._controllerLeft - _loc4_;
               ...
               {
                  if(this._controllerRight > -_loc6_)
                  {
               ...
               {
                  if(this._controllerBottom > param1.compositionHeight - _loc7_)
                  {
      ...
      protected function advanceToNextContainer() : void
      {
         ...
         var _loc1_:flashx.textLayout.compose.Parcel = !!this._parcelList.atLast()?null:this._parcelList.getParcelAt(this._parcelList.currentParcelIndex + 1);
         ...
         {
            _loc1_ = !!this._parcelList.atLast()?null:this._parcelList.getParcelAt(this._parcelList.currentParcelIndex + 1);
            _loc3_ = !!_loc1_?ContainerController(_loc1_.controller):null;
            if(_loc2_ != _loc3_)
            {
               break;
            }
      ...
      protected function parcelHasChanged(param1:flashx.textLayout.compose.Parcel) : void
      {
         var _loc2_:ContainerController = !!this._curParcel?ContainerController(this._curParcel.controller):null;
         ...
         if(_loc2_ != _loc3_)
         {
            ...
            if(this._flowComposer.numControllers > 1)
            {
               ...
               else if(!this._curParcel.isTableParcel)
               {
            ...
            if(_loc3_)
            {
               ...
               this._curInteractiveObjects = _loc3_.interactiveObjects;
      ...
      protected function pushInsideListItemMargins(param1:TextLine) : void
      {
         ...
         {
            _loc2_ = flashx.textLayout.compose.TextFlowLine.getNumberLineInsideLineWidth(param1);
      ...
      private function gotoParcel(param1:int, param2:Number = 0) : Boolean
      {
         this.parcelHasChanged(this._parcelList.getParcelAt(param1));
         return this._parcelList.gotoParcel(param1,param2);
      }
   }
}
