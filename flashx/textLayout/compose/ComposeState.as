package flashx.textLayout.compose
{
   ...
   public class ComposeState extends BaseCompose
   {
      ...
      {
         var _loc1_:flashx.textLayout.compose.ComposeState = _sharedComposeState;
         if(_loc1_)
         {
      ...
      tlf_internal static function releaseComposeState(param1:flashx.textLayout.compose.ComposeState) : void
      {
      ...
      override protected function composeNextLine() : TextLine
      {
         ...
         {
            if(_loc3_ && _loc2_.textLength > 0 && _loc2_.paragraph.getCharCodeAtPosition(_loc2_.absoluteStart + _loc2_.textLength - 1) == 173)
            {
               _loc3_ = false;
            }
         }
