   ...
   public class SimpleCompose extends BaseCompose
   {
      ...
      override protected function composeNextLine() : TextLine
      {
         ...
         if(_listItemElement && _listItemElement.getAbsoluteStart() == _curElementStart + _curElementOffset)
         {
            ...
            _loc1_ = flashx.textLayout.compose.TextFlowLine.createNumberLine(_listItemElement,_curParaElement,_flowComposer.swfContext,!!_loc3_?Number(_parcelList.rightMargin):Number(_parcelList.leftMargin));
            ...
            for each(_loc6_ in this._lines)
            {
               ...
               if(_loc17_ != _loc15_)
               {
                  ...
                  while(_loc20_ && _loc20_.parent)
                  {
                     if(_loc5_)
                     {
                        _loc13_ = _loc13_ + (_loc20_.getEffectivePaddingRight() + _loc20_.getEffectiveBorderRightWidth() + _loc20_.getEffectiveMarginRight());
                        _loc14_ = _loc14_ + (_loc20_.getEffectivePaddingTop() + _loc20_.getEffectiveBorderTopWidth() + _loc20_.getEffectiveMarginTop());
                     }
                     else
                     {
                        _loc13_ = _loc13_ + (_loc20_.getEffectivePaddingTop() + _loc20_.getEffectiveBorderTopWidth() + _loc20_.getEffectiveMarginTop());
                        _loc14_ = _loc14_ + (_loc20_.getEffectivePaddingLeft() + _loc20_.getEffectiveBorderLeftWidth() + _loc20_.getEffectiveMarginLeft());
                     }
               ...
               if(_loc6_.numChildren > 0)
               {
                  ...
                  _loc18_ = flashx.textLayout.compose.TextFlowLine.getTextLineTypographicAscent(_loc6_,_loc16_,_loc21_,_loc7_ + _loc6_.rawTextLength);
               }
               if(_loc11_ != _loc17_)
               {
               ...
               _loc19_ = flashx.textLayout.compose.TextFlowLine.findNumberLine(_loc6_);
               if(_loc19_)
               {
