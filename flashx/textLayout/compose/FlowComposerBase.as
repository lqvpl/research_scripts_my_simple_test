package flashx.textLayout.compose
{
   ...
   public class FlowComposerBase
   {
      ...
      tlf_internal static function computeBaseSWFContext(param1:flashx.textLayout.compose.ISWFContext) : flashx.textLayout.compose.ISWFContext
      {
      ...
      public function set swfContext(param1:flashx.textLayout.compose.ISWFContext) : void
      {
         var _loc2_:flashx.textLayout.compose.ISWFContext = null;
         var _loc3_:flashx.textLayout.compose.ISWFContext = null;
