package flashx.textLayout.operations
{
   ...
   public class InsertInlineGraphicOperation extends FlowTextOperation
   {
      ...
      public function InsertInlineGraphicOperation(param1:SelectionState, param2:Object, param3:Object, param4:Object, param5:Object = null)
      {
         ...
         {
            this.delSelOp = new flashx.textLayout.operations.DeleteTextOperation(param1);
         }
         this._source = param2;
      ...
      override public function doOperation() : Boolean
      {
         ...
         while(_loc4_ is SubParagraphGroupElementBase)
         {
            ...
            if(_loc7_ == 0 && !(_loc4_ as SubParagraphGroupElementBase).acceptTextBefore() || _loc7_ == _loc4_.textLength && !(_loc4_ as SubParagraphGroupElementBase).acceptTextAfter())
            {
