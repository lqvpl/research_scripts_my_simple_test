         ...
         if(!param1)
         {
            ...
            if(_loc2_ < _loc5_ + _loc4_.textLength - 1)
            {
               ...
               while(true)
               {
                  ...
                  _loc2_ = _loc2_ - _loc7_.parentRelativeStart;
                  _loc3_ = _loc3_ - _loc7_.parentRelativeStart;
         ...
         if(_loc5_ >= 0)
         {
            if(_loc5_ >= _loc1_.textLength - 1)
            {
               ...
               if(_loc4_ != 0)
               {
                  ...
                  if(_loc7_ is SpanElement && _loc7_.textLength == 1 && (_loc7_ as SpanElement).hasParagraphTerminator)
                  {
                     _loc4_--;
                  }
               }
