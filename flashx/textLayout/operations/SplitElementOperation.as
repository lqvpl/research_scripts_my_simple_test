   ...
   public class SplitElementOperation extends FlowTextOperation
   {
      ...
      override public function doOperation() : Boolean
      {
         ...
         if(_loc1_ != null && !(_loc1_ is SubParagraphGroupElementBase) && _loc1_.getTextFlow() == textFlow)
         {
            ...
            if(_loc1_ is ParagraphElement)
            {
               _loc7_ = new TextLayoutFormat(this._newElement.format);
               _loc7_.containerBreakAfter = undefined;
               _loc7_.containerBreakBefore = undefined;
               _loc7_.columnBreakAfter = undefined;
               _loc7_.columnBreakBefore = undefined;
               this._newElement.format = _loc7_;
               if(textFlow.interactionManager && _loc4_ != textFlow.textLength)
               {
