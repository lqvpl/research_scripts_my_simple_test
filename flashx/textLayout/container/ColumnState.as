package flashx.textLayout.container
{
   ...
   public class ColumnState
   {
      ...
      public function getCellAt(param1:int) : TableDataCellElement
      {
         return this._tableCellArray[param1];
      }
      
      public function pushTableCell(param1:TableDataCellElement) : void
      {
         if(this._tableCellArray == null)
         {
            this._tableCellArray = new Array();
         }
         this._tableCellArray.push(param1);
      }
