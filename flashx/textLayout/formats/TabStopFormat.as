package flashx.textLayout.formats
{
   ...
   public class TabStopFormat implements flashx.textLayout.formats.ITabStopFormat
   {
      ...
      public function TabStopFormat(param1:flashx.textLayout.formats.ITabStopFormat = null)
      {
         super();
         if(param1)
         {
      ...
      public static function isEqual(param1:flashx.textLayout.formats.ITabStopFormat, param2:flashx.textLayout.formats.ITabStopFormat) : Boolean
      {
         if(param1 == null)
         {
      ...
      public function copy(param1:flashx.textLayout.formats.ITabStopFormat) : void
      {
         if(param1 == null)
         {
            param1 = emptyTabStopFormat;
      ...
      public function concat(param1:flashx.textLayout.formats.ITabStopFormat) : void
      {
      ...
      public function concatInheritOnly(param1:flashx.textLayout.formats.ITabStopFormat) : void
      {
      ...
      public function apply(param1:flashx.textLayout.formats.ITabStopFormat) : void
      {
      ...
      public function removeMatching(param1:flashx.textLayout.formats.ITabStopFormat) : void
      {
         if(param1 == null)
         {
            return;
      ...
      public function removeClashing(param1:flashx.textLayout.formats.ITabStopFormat) : void
      {
         if(param1 == null)
         {
            return;
