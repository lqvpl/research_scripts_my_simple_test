package flashx.textLayout.utils
{
   ...
   public final class NavigationUtil
   {
      ...
      private static function previousAtomHelper(param1:TextFlow, param2:ParagraphElement, param3:int, param4:int) : int
      {
         ...
         var _loc5_:Number = param2.getAbsoluteStart() + param2.textLength;
         param2.getTextFlow().flowComposer.composeToPosition(_loc5_);
      ...
      public static function previousWordPosition(param1:TextFlow, param2:int) : int
      {
         ...
         var _loc5_:Number = _loc3_.getAbsoluteStart() + _loc3_.textLength;
         _loc3_.getTextFlow().flowComposer.composeToPosition(_loc5_);
         ...
         do
         {
            _loc7_ = _loc3_.findPreviousWordBoundary(_loc6_);
            if(_loc6_ == _loc7_)
            {
               _loc6_ = _loc3_.findPreviousWordBoundary(_loc6_ - 1);
            }
            else
            {
               _loc6_ = _loc7_;
         ...
         while(_loc6_ > 0 && CharacterUtil.isWhitespace(_loc3_.getCharCodeAtPosition(_loc6_)));
      ...
      public static function nextWordPosition(param1:TextFlow, param2:int) : int
      {
         ...
         while(_loc6_ < _loc3_.textLength - 1 && CharacterUtil.isWhitespace(_loc3_.getCharCodeAtPosition(_loc6_)));
