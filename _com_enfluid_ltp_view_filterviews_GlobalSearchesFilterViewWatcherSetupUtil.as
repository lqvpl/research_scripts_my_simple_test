package
{
   ...
   public class _com_enfluid_ltp_view_filterviews_GlobalSearchesFilterViewWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _com_enfluid_ltp_view_filterviews_GlobalSearchesFilterViewWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         GlobalSearchesFilterView.watcherSetupUtil = new _com_enfluid_ltp_view_filterviews_GlobalSearchesFilterViewWatcherSetupUtil();
      }
      ...
      public function setup(param1:Object, param2:Function, param3:Function, param4:Array, param5:Array) : void
      {
         ...
         param5[3] = new PropertyWatcher("globalSearchesFilterMin",{"propertyChange":true},[param4[0]],null);
         param5[4] = new PropertyWatcher("globalSearchesFilterMax",{"propertyChange":true},[param4[1]],null);
