package
{
   ...
   public class _com_enfluid_ltp_view_renderers_PendingSeedKeywordItemRendererWatcherSetupUtil implements IWatcherSetupUtil2
   {
      ...
      {
         param5[10] = new PropertyWatcher("closelyrelated",{"propertyChange":true},[param4[10]],param2);
         param5[11] = new PropertyWatcher("selected",{"propertyChange":true},[param4[10]],null);
         param5[5] = new PropertyWatcher("seedKeyword",{"propertyChange":true},[param4[2],param4[3],param4[5],param4[7]],param2);
         ...
         param5[9] = new PropertyWatcher("isRelatedKeywordsOnly",{"propertyChange":true},[param4[7]],null);
         param5[1] = new PropertyWatcher("includeTI",{"propertyChange":true},[param4[0],param4[8]],param2);
         ...
         param5[3] = new PropertyWatcher("excludeTI",{"propertyChange":true},[param4[0],param4[9]],param2);
         param5[4] = new PropertyWatcher("text",{
            "change":true,
            "textChanged":true
         },[param4[0],param4[9]],null);
