package com.enfluid.ltp.view.renderers.headers
{
   ...
   public final class CustomHeaderRendererInnerClass0 extends Path implements IGridVisualElement
   {
      ...
      private var _88844982outerDocument:com.enfluid.ltp.view.renderers.headers.CustomHeaderRenderer;
      
      public function CustomHeaderRendererInnerClass0()
      {
         super();
         this.data = "M 3.5 7.0 L 0.0 0.0 L 7.0 0.0 L 3.5 7.0";
         this.fill = this._CustomHeaderRendererInnerClass0_RadialGradient1_c();
      }
      ...
      private final function _CustomHeaderRendererInnerClass0_RadialGradient1_c() : RadialGradient
      {
         ...
         _loc1_.entries = [this._CustomHeaderRendererInnerClass0_GradientEntry1_i(),this._CustomHeaderRendererInnerClass0_GradientEntry2_i()];
         return _loc1_;
      }
      
      private final function _CustomHeaderRendererInnerClass0_GradientEntry1_i() : GradientEntry
      {
      ...
      private final function _CustomHeaderRendererInnerClass0_GradientEntry2_i() : GradientEntry
      {
         var _loc1_:GradientEntry = new GradientEntry();
         §§push(_loc1_);
         §§push(0);
      ...
      [Bindable(event="propertyChange")]
      public function get outerDocument() : com.enfluid.ltp.view.renderers.headers.CustomHeaderRenderer
      {
         return this._88844982outerDocument;
      }
      
      public function set outerDocument(param1:com.enfluid.ltp.view.renderers.headers.CustomHeaderRenderer) : void
      {
