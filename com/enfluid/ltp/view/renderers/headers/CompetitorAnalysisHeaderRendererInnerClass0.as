package com.enfluid.ltp.view.renderers.headers
{
   ...
   public final class CompetitorAnalysisHeaderRendererInnerClass0 extends Path implements IGridVisualElement
   {
      ...
      public function CompetitorAnalysisHeaderRendererInnerClass0()
      {
         ...
         this.fill = this._CompetitorAnalysisHeaderRendererInnerClass0_RadialGradient1_c();
      }
      ...
      private final function _CompetitorAnalysisHeaderRendererInnerClass0_RadialGradient1_c() : RadialGradient
      {
      ...
      private final function _CompetitorAnalysisHeaderRendererInnerClass0_GradientEntry1_i() : GradientEntry
      {
      ...
      private final function _CompetitorAnalysisHeaderRendererInnerClass0_GradientEntry2_i() : GradientEntry
      {
         var _loc1_:GradientEntry = new GradientEntry();
         §§push(_loc1_);
         §§push(0);
      ...
      [Bindable(event="propertyChange")]
      public function get outerDocument() : com.enfluid.ltp.view.renderers.headers.CompetitorAnalysisHeaderRenderer
      {
         return this._88844982outerDocument;
      }
      
      public function set outerDocument(param1:com.enfluid.ltp.view.renderers.headers.CompetitorAnalysisHeaderRenderer) : void
      {
