package com.enfluid.ltp.view.skins
{
   ...
   public final class SlimScrollerSkin extends SparkSkin
   {
      ...
      private var _213507019hostComponent:SlimScroller;
      
      public function SlimScrollerSkin()
      {
         super();
         mx_internal::_document = this;
         this._SlimScrollerSkin_ClassFactory2_i();
         this._SlimScrollerSkin_ClassFactory1_i();
      }
      ...
      private final function _SlimScrollerSkin_ClassFactory2_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = SlimScrollerSkinInnerClass1;
      ...
      private final function _SlimScrollerSkin_ClassFactory1_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = SlimScrollerSkinInnerClass0;
         _loc1_.properties = {"outerDocument":this};
      ...
      [Bindable(event="propertyChange")]
      public function get hostComponent() : SlimScroller
      {
         return this._213507019hostComponent;
      }
      
      public function set hostComponent(param1:SlimScroller) : void
      {
